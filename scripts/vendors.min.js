    ...
    return function(t) {
        ...
        (function(e) {
            ! function(n) {
                ...
                function o(t, e) {
                    ...
                    0 !== t._state ? (t._handled = !0, h(function() {
                        ...
                        if (null !== t) {
                            ...
                            s(e.promise, n)
                        } else(1 === r._state ? s : a)(e.promise, r._value)
                    })) : t._deferreds.push(e)
                }
                ...
                var f = setTimeout,
                    h = "function" == typeof e && e || function(t) {
                        f(t, 0)
                    },
                    d = function(t) {
        ...
        var r = n(5),
            ...
            s = n(8),
            a = n(9),
            wrapperClass = document.getElementsByClassName('s-main')[0],
            c = {
                Dom: n(12),
                History: a,
                Cache: s,
                ...
                init: function() {
                    ...
                    wrapperClass.setAttribute("aria-live", "polite"), this.History.add(this.getCurrentUrl(), this.Dom.getNamespace(t)), i.trigger("initStateChange", this.History.currentStatus()), i.trigger("newPageReady", this.History.currentStatus(), {}, t, this.Dom.currentHTML), i.trigger("transitionCompleted", this.History.currentStatus()), this.bindEvents()
                },
                bindEvents: function() {
        ...
        var n = {
            ...
            getWrapper: function() {
                var t = document.getElementsByClassName(this.wrapperClass);
...
! function(t) {
    var e = {
        ...
        addDevicePattern: function(t) {
            t && (this.device_pattern.push(t), this.cache = null)
        },
        addTabletPattern: function(t) {
            t && (this.tablet_pattern.push(t), this.cache = null)
        },
        detect: function() {
            if (this.cache) return this.cache;
            if (this.ua || (this.ua = navigator.userAgent.toLowerCase()), this.isMobile()) return this.returnObj();
            var t = this.isIE();
            return t ? (this.result.browser = "ie", this.result.ie_version = t, this.returnObj()) : (this.result.browser = this.whichBrowser(), this.returnObj())
        },
        returnObj: function() {
            return this.result.ua = navigator.userAgent, this.cache = this.result, this.cache
        },
        isMobile: function() {
            var t = new RegExp(this.device_pattern.join("|"), "i"),
                e = this.ua.match(t);
            if (!e) return !1;
            var r = e[0];
            return this.result.mobile = r, this.result.browser = this.whichBrowser(), "ipad" == r && (this.result.is_tablet = !0), "android" == r && this.isAndroidTablet() && (this.result.is_tablet = !0), !0
        },
        isAndroidTablet: function() {
            return !!this.checkTabletPattern() || !this.ua.match("mobile")
        },
        checkTabletPattern: function() {
            var t = this.tablet_pattern.length;
            if (!t) return !1;
            for (var e = 0; e < t; e++) {
                var r = new RegExp(this.tablet_pattern[e], "i");
                if (this.ua.match(r)) return !0
            }
            return !1
        },
        isIE: function() {
            return window.ActiveXObject ? document.documentMode ? document.documentMode : void 0 === document.documentElement.style.maxHeight ? 6 : void 0 === document.querySelectorAll ? 7 : 6 : !!document.documentMode && document.documentMode
        },
        whichBrowser: function() {
            for (var t = this.browser_pattern.length, e = 0; e < t; e++) {
                var r = this.browser_pattern[e];
                if (this.ua.match(r)) return r.replace("ms", "")
            }
            return "unknown"
        }
    };
    t.detectBrowser = {
        ...
        addTabletPattern: function(t) {
            e.addTabletPattern(t)
        },
        addDevicePattern: function(t) {
            e.addDevicePattern(t)
        },
        detect: function() {
            return e.detect()
        },
...
}(jQuery), $.detectBrowser.mobile() && $("body").addClass("d-mobile d-touch"), $.detectBrowser.isTablet() && $("body").addClass("d-tablet d-touch").removeClass("d-mobile");
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(e, t, o) {
            var n, r, i, a, l, s, d, c, f, p = {
                ...
                E = 0,
                O = _gsScope.navigator && -1 !== _gsScope.navigator.userAgent.toLowerCase().indexOf("android"),
                B = 0,
                R = {},
                A = {},
                W = function(e) {
                ...
                V = function(e) {
                    P.push(e), 1 === P.length && t.ticker.addEventListener("tick", H, this, !1, 1)
                },
                I = function(e) {
                ...
                G = function() {
                    P.length || t.ticker.removeEventListener("tick", H)
                },
                j = function(e, t) {
                    var o;
                ...
                z = function() {
                    return null != window.pageYOffset ? window.pageYOffset : null != m.scrollTop ? m.scrollTop : w.scrollTop || m.body.scrollTop || 0
                },
                U = function() {
                    return null != window.pageXOffset ? window.pageXOffset : null != m.scrollLeft ? m.scrollLeft : w.scrollLeft || m.body.scrollLeft || 0
                },
                $ = function(e, t) {
                    Oe(e, "scroll", t), Z(e.parentNode) || $(e.parentNode, t)
                },
                K = function(e, t) {
                    Be(e, "scroll", t), Z(e.parentNode) || K(e.parentNode, t)
                },
                Z = function(e) {
                    return !(e && e !== w && e !== m && e !== m.body && e !== window && e.nodeType && e.parentNode)
                },
                q = function(e, t) {
                    var o = "x" === t ? "Width" : "Height",
                        ...
                        r = "client" + o,
                        i = m.body;
                    return Math.max(0, Z(e) ? Math.max(w[n], i[n]) - (window["inner" + o] || w[r] || i[r]) : e[n] - e[r])
                },
                Q = function(e) {
                    var t = Z(e),
                        o = q(e, "x"),
                        n = q(e, "y");
                    t ? e = A : Q(e.parentNode), e._gsMaxScrollX = o, e._gsMaxScrollY = n, e._gsScrollX = e.scrollLeft || 0, e._gsScrollY = e.scrollTop || 0
                },
                J = function(e, t) {
                    return e = e || window.event, y.pageX = e.clientX + m.body.scrollLeft + w.scrollLeft, y.pageY = e.clientY + m.body.scrollTop + w.scrollTop, t && (e.returnValue = !1), y
                },
                ee = function(e) {
                ...
                ne = m.defaultView ? m.defaultView.getComputedStyle : L,
                re = /(?:Left|Right|Width)/i,
                ie = /(?:\d|\-|\+|=|#|\.)*/g,
                ae = function(e, t, o, n, r) {
                    if ("px" === n || !n) return o;
                    ...
                    var i, a = re.test(t),
                        ...
                        s = T.style,
                        d = 0 > o;
                    return d && (o = -o), "%" === n && -1 !== t.indexOf("border") ? i = o / 100 * (a ? e.clientWidth : e.clientHeight) : (s.cssText = "border:0 solid red;position:" + se(e, "position", !0) + ";line-height:0;", "%" !== n && l.appendChild ? s[a ? "borderLeftWidth" : "borderTopWidth"] = o + n : (l = e.parentNode || m.body, s[a ? "width" : "height"] = o + n), l.appendChild(T), i = parseFloat(T[a ? "offsetWidth" : "offsetHeight"]), l.removeChild(T), 0 !== i || r || (i = ae(e, t, o, n, !0))), d ? -i : i
                },
                le = function(e, t) {
                    if ("absolute" !== se(e, "position", !0)) return 0;
                    var o = "left" === t ? "Left" : "Top",
                        n = se(e, "margin" + o, !0);
                    return e["offset" + o] - (ae(e, t, parseFloat(n), (n + "").replace(ie, "")) || 0)
                },
                se = function(e, t, o) {
                    var n, r = (e._gsTransform || {})[t];
                    return r || 0 === r ? r : (e.style[t] ? r = e.style[t] : (n = ne(e)) ? (r = n.getPropertyValue(t.replace(/([A-Z])/g, "-$1").toLowerCase()), r = r || n.length ? r : n[t]) : e.currentStyle && (r = e.currentStyle[t]), "auto" !== r || "top" !== t && "left" !== t || (r = le(e, t)), o ? r : parseFloat(r) || 0)
                },
                de = function(e, t, o) {
                    var n = e.vars,
                        r = n[o],
                ...
                ce = function(e, t) {
                    var o, n, r, i = ee(e);
                    return i ? Pe(i, t) : void 0 !== e.left ? (r = Le(t), {
                        left: e.left - r.x,
                        top: e.top - r.y,
                        width: e.width,
                        height: e.height
                ...
                fe = function() {
                    if (!m.createElementNS) return a = 0, void(l = !1);
                    var e, t, o, n, r = b("div"),
                        i = m.createElementNS("http://www.w3.org/2000/svg", "svg"),
                        f = b("div"),
                        p = r.style,
                        u = m.body || w,
                        h = "flex" === se(u, "display", !0);
                    m.body && he && (p.position = "absolute", u.appendChild(f), f.appendChild(r), n = r.offsetParent, f.style[he] = "rotate(1deg)", c = r.offsetParent === n, f.style.position = "absolute", p.height = "10px", n = r.offsetTop, f.style.border = "5px solid red", d = n !== r.offsetTop, u.removeChild(f)), p = i.style, i.setAttributeNS(null, "width", "400px"), i.setAttributeNS(null, "height", "400px"), i.setAttributeNS(null, "viewBox", "0 0 400 400"), p.display = "block", p.boxSizing = "border-box", p.border = "0px solid red", p.transform = "none", r.style.cssText = "width:100px;height:100px;overflow:scroll;-ms-overflow-style:none;", u.appendChild(r), r.appendChild(i), o = i.createSVGPoint().matrixTransform(i.getScreenCTM()), t = o.y, r.scrollTop = 100, o.x = o.y = 0, o = o.matrixTransform(i.getScreenCTM()), s = t - o.y < 100.1 ? 0 : t - o.y - 150, r.removeChild(i), u.removeChild(r), u.appendChild(i), h && (u.style.display = "block"), e = i.getScreenCTM(), t = e.e, p.border = "50px solid red", e = i.getScreenCTM(), 0 === t && 0 === e.e && 0 === e.f && 1 === e.a ? (a = 1, l = !0) : (a = t !== e.e ? 1 : 0, l = 1 !== e.a), h && (u.style.display = "flex"), u.removeChild(i)
                },
                pe = "" !== te(T, "perspective"),
                ue = te(T, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
                he = te(T, "transform"),
                ge = he.replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
                xe = {},
                ye = {},
                ve = _gsScope.SVGElement,
                me = function(e) {
                ...
                Se = function(e) {
                    ...
                    if (je.cacheSVGData !== !1 && e._dCache && e._dCache.lastUpdate === t.ticker.frame) return e._dCache;
                    var o, n, r, i, d, c, f, p, u, h, g, x, y = e,
                        v = Ce(e);
                    if (v.lastUpdate = t.ticker.frame, e.getBBox && !v.isSVGRoot) {
                        for (y = e.parentNode, o = e.getBBox(); y && "svg" !== (y.nodeName + "").toLowerCase();) y = y.parentNode;
                        return i = Se(y), v.offsetTop = o.y * i.scaleY, v.offsetLeft = o.x * i.scaleX, v.scaleX = i.scaleX, v.scaleY = i.scaleY, v.offsetParent = y || w, v
                    }
                    for (r = v.offsetParent, r === m.body && (r = w), Te.length = be.length = 0; y && (d = se(y, he, !0), "matrix(1, 0, 0, 1, 0, 0)" !== d && "none" !== d && "translate3d(0px, 0px, 0px)" !== d && (Te.push(y), be.push(y.style[he]), y.style[he] = "none"), y !== r);) y = y.parentNode;
                    for (n = r.getBoundingClientRect(), d = e.getScreenCTM(), p = e.createSVGPoint(), f = p.matrixTransform(d), p.x = p.y = 10, p = p.matrixTransform(d), v.scaleX = (p.x - f.x) / 10, v.scaleY = (p.y - f.y) / 10, void 0 === a && fe(), v.borderBox && !l && e.getAttribute("width") && (i = ne(e) || {}, u = parseFloat(i.borderLeftWidth) + parseFloat(i.borderRightWidth) || 0, h = parseFloat(i.borderTopWidth) + parseFloat(i.borderBottomWidth) || 0, g = parseFloat(i.width) || 0, x = parseFloat(i.height) || 0, v.scaleX *= (g - u) / g, v.scaleY *= (x - h) / x), s ? (o = e.getBoundingClientRect(), v.offsetLeft = o.left - n.left, v.offsetTop = o.top - n.top) : (v.offsetLeft = f.x - n.left, v.offsetTop = f.y - n.top), v.offsetParent = r, c = Te.length; --c > -1;) Te[c].style[he] = be[c];
                    return v
                },
                Le = function(e, o) {
                    ...
                    var n = ne(e),
                        ...
                        l = -1 !== r.indexOf("top") ? "0%" : -1 !== r.indexOf("bottom") ? "100%" : i[1];
                    return ("center" === l || null == l) && (l = "50%"), ("center" === a || isNaN(parseFloat(a))) && (a = "50%"), e.getBBox && me(e) ? (e._gsTransform || (t.set(e, {
                        x: "+=0",
                        overwrite: !1
                    }), void 0 === e._gsTransform.xOrigin && console.log("Draggable requires at least GSAP 1.17.0")), r = e.getBBox(), o.x = e._gsTransform.xOrigin - r.x, o.y = e._gsTransform.yOrigin - r.y) : (e.getBBox && -1 !== (a + l).indexOf("%") && (e = e.getBBox(), e = {
                        offsetWidth: e.width,
                        offsetHeight: e.height
                    }), o.x = -1 !== a.indexOf("%") ? e.offsetWidth * parseFloat(a) / 100 : parseFloat(a), o.y = -1 !== l.indexOf("%") ? e.offsetHeight * parseFloat(l) / 100 : parseFloat(l)), o
                },
                Ce = function(e) {
                    if (je.cacheSVGData !== !1 && e._dCache && e._dCache.lastUpdate === t.ticker.frame) return e._dCache;
                    ...
                    if (n.isSVG = i, n.isSVGRoot = a, n.borderBox = "border-box" === r.boxSizing, n.computedStyle = r, a) o = e.parentNode || w, o.insertBefore(T, e), n.offsetParent = T.offsetParent || w, o.removeChild(T);
                    else if (i) {
                ...
                Me = function(e, t, o, n, r) {
                    if (e === window || !e || !e.style || !e.parentNode) return [1, 0, 0, 1, 0, 0];
                    var i, l, s, f, p, u, h, g, x, y, v, b, T, S, L = e._dCache || Ce(e),
                        C = e.parentNode,
                        M = C._dCache || Ce(C),
                        N = L.computedStyle,
                        X = L.isSVG ? M.offsetParent : C.offsetParent;
                    return i = L.isSVG && -1 !== (e.style[he] + "").indexOf("matrix") ? e.style[he] : N ? N.getPropertyValue(ge) : e.currentStyle ? e.currentStyle[he] : "1,0,0,1,0,0", e.getBBox && -1 !== (e.getAttribute("transform") + "").indexOf("matrix") && (i = e.getAttribute("transform")), i = (i + "").match(/(?:\-|\.|\b)(\d|\.|e\-)+/g) || [1, 0, 0, 1, 0, 0], i.length > 6 && (i = [i[0], i[1], i[4], i[5], i[12], i[13]]), n ? i[4] = i[5] = 0 : L.isSVG && (p = e._gsTransform) && (p.xOrigin || p.yOrigin) && (i[0] = parseFloat(i[0]), i[1] = parseFloat(i[1]), i[2] = parseFloat(i[2]), i[3] = parseFloat(i[3]), i[4] = parseFloat(i[4]) - (p.xOrigin - (p.xOrigin * i[0] + p.yOrigin * i[2])), i[5] = parseFloat(i[5]) - (p.yOrigin - (p.xOrigin * i[1] + p.yOrigin * i[3]))), t && (void 0 === a && fe(), s = L.isSVG || L.isSVGRoot ? Se(e) : e, L.isSVG ? (f = e.getBBox(), y = M.isSVGRoot ? {
                        x: 0,
                        y: 0
                    } : C.getBBox(), s = {
                        offsetLeft: f.x - y.x,
                        offsetTop: f.y - y.y,
                        offsetParent: L.offsetParent
                    }) : L.isSVGRoot ? (v = parseInt(N.borderTopWidth, 10) || 0, b = parseInt(N.borderLeftWidth, 10) || 0, T = (i[0] - a) * b + i[2] * v, S = i[1] * b + (i[3] - a) * v, u = t.x, h = t.y, g = u - (u * i[0] + h * i[2]), x = h - (u * i[1] + h * i[3]), i[4] = parseFloat(i[4]) + g, i[5] = parseFloat(i[5]) + x, t.x -= g, t.y -= x, u = s.scaleX, h = s.scaleY, r || (t.x *= u, t.y *= h), i[0] *= u, i[1] *= h, i[2] *= u, i[3] *= h, we || (t.x += T, t.y += S), X === m.body && s.offsetParent === w && (X = w)) : !d && e.offsetParent && (t.x += parseInt(se(e.offsetParent, "borderLeftWidth"), 10) || 0, t.y += parseInt(se(e.offsetParent, "borderTopWidth"), 10) || 0), l = C === w || C === m.body, i[4] = Number(i[4]) + t.x + (s.offsetLeft || 0) - o.x - (l ? 0 : C.scrollLeft || 0), i[5] = Number(i[5]) + t.y + (s.offsetTop || 0) - o.y - (l ? 0 : C.scrollTop || 0), C && "fixed" === se(e, "position", N) && (i[4] += U(), i[5] += z()), !C || C === w || X !== s.offsetParent || M.isSVG || c && "100100" !== Me(C).join("") || (s = M.isSVGRoot ? Se(C) : C, i[4] -= s.offsetLeft || 0, i[5] -= s.offsetTop || 0, d || !M.offsetParent || L.isSVG || L.isSVGRoot || (i[4] -= parseInt(se(M.offsetParent, "borderLeftWidth"), 10) || 0, i[5] -= parseInt(se(M.offsetParent, "borderTopWidth"), 10) || 0))), i
                },
                Ne = function(e, t) {
                    if (!e || e === window || !e.parentNode) return [1, 0, 0, 1, 0, 0];
                    for (var o, n, r, i, a, l, s, d, c = Le(e, xe), f = Le(e.parentNode, ye), p = Me(e, c, f, !1, !t);
                        (e = e.parentNode) && e.parentNode && e !== w;) c = f, f = Le(e.parentNode, c === xe ? ye : xe), s = Me(e, c, f), o = p[0], n = p[1], r = p[2], i = p[3], a = p[4], l = p[5], p[0] = o * s[0] + n * s[2], p[1] = o * s[1] + n * s[3], p[2] = r * s[0] + i * s[2], p[3] = r * s[1] + i * s[3], p[4] = a * s[0] + l * s[2] + s[4], p[5] = a * s[1] + l * s[3] + s[5];
                    return t && (o = p[0], n = p[1], r = p[2], i = p[3], a = p[4], l = p[5], d = o * i - n * r, p[0] = i / d, p[1] = -n / d, p[2] = -r / d, p[3] = o / d, p[4] = (r * l - i * a) / d, p[5] = -(o * l - n * a) / d), p
                },
                Xe = function(e, t, o, n, r) {
                    e = ee(e);
                    var i = Ne(e, !1, r),
                        a = t.x,
                        l = t.y;
                    return o && (Le(e, t), a -= t.x, l -= t.y), n = n === !0 ? t : n || {}, n.x = a * i[0] + l * i[2] + i[4], n.y = a * i[1] + l * i[3] + i[5], n
                },
                Ye = function(e, t, o) {
                ...
                Pe = function(e, t, o) {
                    ...
                    t = ee(t);
                    var n, r, i, a, l, s, d, c, f, p, u, h, g, x, y, v, b, T, S, L, C, M, N = e.getBBox && me(e);
                    if (e === window) a = z(), r = U(), i = r + (w.clientWidth || e.innerWidth || m.body.clientWidth || 0), l = a + ((e.innerHeight || 0) - 20 < w.clientHeight ? w.clientHeight : e.innerHeight || m.body.clientHeight || 0);
                    else {
                        if (void 0 === t || t === window) return e.getBoundingClientRect();
                        n = Le(e), r = -n.x, a = -n.y, N ? (h = e.getBBox(), g = h.width, x = h.height) : "svg" !== (e.nodeName + "").toLowerCase() && e.offsetWidth ? (g = e.offsetWidth, x = e.offsetHeight) : (C = ne(e), g = parseFloat(C.width), x = parseFloat(C.height)), i = r + g, l = a + x, "svg" !== e.nodeName.toLowerCase() || X || (y = Se(e), M = y.computedStyle || {}, T = (e.getAttribute("viewBox") || "0 0").split(" "), S = parseFloat(T[0]), L = parseFloat(T[1]), v = parseFloat(M.borderLeftWidth) || 0, b = parseFloat(M.borderTopWidth) || 0, i -= g - (g - v) / y.scaleX - S, l -= x - (x - b) / y.scaleY - L, r -= v / y.scaleX - S, a -= b / y.scaleY - L, C && (i += (parseFloat(M.borderRightWidth) + v) / y.scaleX, l += (b + parseFloat(M.borderBottomWidth)) / y.scaleY))
                    }
                    return e === t ? {
                        left: r,
                        top: a,
                        ...
                        x: r,
                        y: l
                    }, s, d), r = Math.min(c.x, f.x, p.x, u.x), a = Math.min(c.y, f.y, p.y, u.y), R.x = R.y = 0, o && Le(t, R), {
                        left: r + R.x,
                        top: a + R.y,
                        width: Math.max(c.x, f.x, p.x, u.x) - r,
                        height: Math.max(c.y, f.y, p.y, u.y) - a
                    })
                },
                _e = function(e) {
                ...
                De = function(e) {
                    ...
                    for (t = 0; i > t; t++)
                        if (o = e[t], _e(o))
                            for (n = o.length, n = 0; n < o.length; n++) r.push(o[n]);
                        else o && 0 !== o.length && r.push(o);
                    return r
                },
                ke = "ontouchstart" in w && "orientation" in window,
                Ee = function(e) {
                    for (var t = e.split(","), o = (void 0 !== T.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== T.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : e).split(","), n = {}, r = 4; --r > -1;) n[t[r]] = o[r], n[o[r]] = t[r];
                    return n
                ...
                Ae = function(e) {
                    r = e.touches && E < e.touches.length, Be(e.target, "touchend", Ae)
                },
                We = function(e) {
                    r = e.touches && E < e.touches.length, Oe(e.target, "touchend", Ae)
                },
                Fe = function(e, t, o, n, r, i) {
                    var a, l, s, d = {};
                    if (t)
                        if (1 !== r && t instanceof Array) {
                            if (d.end = a = [], s = t.length, "object" == typeof t[0])
                                for (l = 0; s > l; l++) a[l] = F(t[l], r);
                            else
                                for (l = 0; s > l; l++) a[l] = t[l] * r;
                            o += 1.1, n -= 1.1
                        } else "function" == typeof t ? d.end = function(o) {
                            var n, i, a = t.call(e, o);
                            if (1 !== r)
                                if ("object" == typeof a) {
                                    n = {};
                    ...
                    return (o || 0 === o) && (d.max = o), (n || 0 === n) && (d.min = n), i && (d.velocity = 0), d
                },
                He = function(e) {
                    var t;
                    return !(!e || !e.getAttribute || "BODY" === e.nodeName) && (!("true" !== (t = e.getAttribute("data-clickable")) && ("false" === t || !e.onclick && !k.test(e.nodeName + "") && "true" !== e.getAttribute("contentEditable"))) || He(e.parentNode))
                },
                Ve = function(e, t) {
                    for (var o, n = e.length; --n > -1;) o = e[n], o.ondragstart = o.onselectstart = t ? null : L, oe(o, "userSelect", t ? "text" : "none")
                },
                Ie = function() {
                    var e, t = m.createElement("div"),
                        ...
                        n = o.style,
                        r = m.body || T;
                    return n.display = "inline-block", n.position = "relative", t.style.cssText = o.innerHTML = "width:90px; height:40px; padding:10px; overflow:auto; visibility: hidden", t.appendChild(o), r.appendChild(t), f = o.offsetHeight + 18 > t.scrollHeight, n.width = "100%", he || (n.paddingRight = "500px", e = t.scrollLeft = t.scrollWidth - t.clientWidth, n.left = "-90px", e = e !== t.scrollLeft), r.removeChild(t), e
                }(),
                Ge = function(e, o) {
                    e = ee(e), o = o || {};
                    var n, r, i, a, l, s, d = m.createElement("div"),
                        c = d.style,
                        p = e.firstChild,
                        u = 0,
                        h = 0,
                        ...
                        b = 0,
                        T = 0;
                    pe && o.force3D !== !1 ? (l = "translate3d(", s = "px,0px)") : he && (l = "translate(", s = "px)"), this.scrollTop = function(e, t) {
                        ...
                        return (i > 2 || -2 > i) && !r ? (x = e.scrollLeft, t.killTweensOf(this, !0, {
                            left: 1,
                            scrollLeft: 1
                        }), this.left(-x), void(o.onKill && o.onKill())) : (n = -n, 0 > n ? (h = n - .5 | 0, n = 0) : n > b ? (h = n - b | 0, n = b) : h = 0, (h || a) && (l ? this._suspendTransforms || (c[he] = l + -h + "px," + -u + s) : c.left = -h + "px", Ie && h + w >= 0 && (c.paddingRight = h + w + "px")), e.scrollLeft = 0 | n, void(x = e.scrollLeft))
                        ...
                        return (i > 2 || -2 > i) && !r ? (g = e.scrollTop, t.killTweensOf(this, !0, {
                            top: 1,
                            scrollTop: 1
                        }), this.top(-g), void(o.onKill && o.onKill())) : (n = -n, 0 > n ? (u = n - .5 | 0, n = 0) : n > T ? (u = n - T | 0, n = T) : u = 0, (u || a) && (l ? this._suspendTransforms || (c[he] = l + -h + "px," + -u + s) : c.top = -u + "px"), e.scrollTop = 0 | n, void(g = e.scrollTop))
                    }, this.maxScrollTop = function() {
                        return T
                    }, this.maxScrollLeft = function() {
                        return b
                    }, this.disable = function() {
                        for (p = d.firstChild; p;) a = p.nextSibling, e.appendChild(p), p = a;
                        e === d.parentNode && e.removeChild(d)
                    }, this.enable = function() {
                        if (p = e.firstChild, p !== d) {
                            for (; p;) a = p.nextSibling, d.appendChild(p), p = a;
                            e.appendChild(d), this.calibrate()
                        }
                    }, this.calibrate = function(t) {
                        var o, a, l = e.clientWidth === n;
                        g = e.scrollTop, x = e.scrollLeft, (!l || e.clientHeight !== r || d.offsetHeight !== i || y !== e.scrollWidth || v !== e.scrollHeight || t) && ((u || h) && (o = this.left(), a = this.top(), this.left(-e.scrollLeft), this.top(-e.scrollTop)), (!l || t) && (c.display = "block", c.width = "auto", c.paddingRight = "0px", w = Math.max(0, e.scrollWidth - e.clientWidth), w && (w += se(e, "paddingLeft") + (f ? se(e, "paddingRight") : 0))), c.display = "inline-block", c.position = "relative", c.overflow = "visible", c.verticalAlign = "top", c.width = "100%", c.paddingRight = w + "px", f && (c.paddingBottom = se(e, "paddingBottom", !0)), X && (c.zoom = "1"), n = e.clientWidth, r = e.clientHeight, y = e.scrollWidth, v = e.scrollHeight, b = e.scrollWidth - n, T = e.scrollHeight - r, i = d.offsetHeight, c.display = "block", (o || a) && (this.left(o), this.top(a)))
                    }, this.content = d, this.element = e, this._suspendTransforms = !1, this.enable()
                },
                je = function(n, a) {
                    e.call(this, n), n = ee(n), i || (i = x.com.greensock.plugins.ThrowPropsPlugin), this.vars = a = F(a || {}), this.target = n, this.x = this.y = this.rotation = 0, this.dragResistance = parseFloat(a.dragResistance) || 0, this.edgeResistance = isNaN(a.edgeResistance) ? 1 : parseFloat(a.edgeResistance) || 0, this.lockAxis = a.lockAxis, this.autoScroll = a.autoScroll || 0, this.lockedAxis = null, this.allowEventDefault = !!a.allowEventDefault;
                    var l, s, d, c, f, y, v, b, T, L, P, k, H, G, z, U, q, te, ne, re, ie, ae, le, fe, pe, ue, he, ge, xe, ye, ve, we, be, Te, Se = (a.type || (X ? "top,left" : "x,y")).toLowerCase(),
                        Le = -1 !== Se.indexOf("x") || -1 !== Se.indexOf("y"),
                        Ce = -1 !== Se.indexOf("rotation"),
                        Me = Ce ? "rotation" : Le ? "x" : "left",
                        Ye = Le ? "y" : "top",
                        Pe = -1 !== Se.indexOf("x") || -1 !== Se.indexOf("left") || "scroll" === Se,
                        _e = -1 !== Se.indexOf("y") || -1 !== Se.indexOf("top") || "scroll" === Se,
                        De = a.minimumMovement || 2,
                        Ae = this,
                        Ie = W(a.trigger || a.handle || n),
                        ze = {},
                        Ue = 0,
                        $e = !1,
                        Ze = a.autoScrollMarginTop || 40,
                        qe = a.autoScrollMarginRight || 40,
                        Qe = a.autoScrollMarginBottom || 40,
                        Je = a.autoScrollMarginLeft || 40,
                        et = a.clickableTest || He,
                        tt = 0,
                        ot = function(e) {
                            return Ae.isPressed && e.which < 2 ? void Ae.endDrag() : (e.preventDefault(), e.stopPropagation(), !1)
                        },
                        nt = function(e) {
                            if (Ae.autoScroll && Ae.isDragging && ($e || te)) {
                                var t, o, r, i, a, l, d, c, f = n,
                                    p = 15 * Ae.autoScroll;
                                for ($e = !1, A.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != w.scrollTop ? w.scrollTop : m.body.scrollTop, A.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != w.scrollLeft ? w.scrollLeft : m.body.scrollLeft, i = Ae.pointerX - A.scrollLeft, a = Ae.pointerY - A.scrollTop; f && !o;) o = Z(f.parentNode), t = o ? A : f.parentNode, r = o ? {
                                    bottom: Math.max(w.clientHeight, window.innerHeight || 0),
                                    right: Math.max(w.clientWidth, window.innerWidth || 0),
                                    left: 0,
                                    top: 0
                                } : t.getBoundingClientRect(), l = d = 0, _e && (c = t._gsMaxScrollY - t.scrollTop, 0 > c ? d = c : a > r.bottom - Qe && c ? ($e = !0, d = Math.min(c, p * (1 - Math.max(0, r.bottom - a) / Qe) | 0)) : a < r.top + Ze && t.scrollTop && ($e = !0, d = -Math.min(t.scrollTop, p * (1 - Math.max(0, a - r.top) / Ze) | 0)), d && (t.scrollTop += d)), Pe && (c = t._gsMaxScrollX - t.scrollLeft, 0 > c ? l = c : i > r.right - qe && c ? ($e = !0, l = Math.min(c, p * (1 - Math.max(0, r.right - i) / qe) | 0)) : i < r.left + Je && t.scrollLeft && ($e = !0, l = -Math.min(t.scrollLeft, p * (1 - Math.max(0, i - r.left) / Je) | 0)), l && (t.scrollLeft += l)), o && (l || d) && (window.scrollTo(t.scrollLeft, t.scrollTop), yt(Ae.pointerX + l, Ae.pointerY + d)), f = t
                            }
                            if (te) {
                                var u = Ae.x,
                                    h = Ae.y,
                                    g = 1e-6;
                                g > u && u > -g && (u = 0), g > h && h > -g && (h = 0), Ce ? (Ae.deltaX = u - xe.data.rotation, xe.data.rotation = Ae.rotation = u, xe.setRatio(1)) : s ? (_e && (Ae.deltaY = h - s.top(), s.top(h)), Pe && (Ae.deltaX = u - s.left(), s.left(u))) : Le ? (_e && (Ae.deltaY = h - xe.data.y, xe.data.y = h), Pe && (Ae.deltaX = u - xe.data.x, xe.data.x = u), xe.setRatio(1)) : (_e && (Ae.deltaY = h - parseFloat(n.style.top || 0), n.style.top = h + "px"), Pe && (Ae.deltaY = u - parseFloat(n.style.left || 0), n.style.left = u + "px")), !b || e || we || (we = !0, de(Ae, "drag", "onDrag"), we = !1)
                            }
                            te = !1
                        },
                        rt = function(e, o) {
                            var r, i = Ae.x,
                                a = Ae.y;
                            n._gsTransform || !Le && !Ce || t.set(n, {
                                x: "+=0",
                                overwrite: !1,
                                data: "_draggable"
                            }), Le ? (Ae.y = n._gsTransform.y, Ae.x = n._gsTransform.x) : Ce ? Ae.x = Ae.rotation = n._gsTransform.rotation : s ? (Ae.y = s.top(), Ae.x = s.left()) : (Ae.y = parseInt(n.style.top, 10) || 0, Ae.x = parseInt(n.style.left, 10) || 0), (re || ie || ae) && !o && (Ae.isDragging || Ae.isThrowing) && (ae && (R.x = Ae.x, R.y = Ae.y, r = ae(R), r.x !== Ae.x && (Ae.x = r.x, te = !0), r.y !== Ae.y && (Ae.y = r.y, te = !0)), re && (r = re(Ae.x), r !== Ae.x && (Ae.x = r, Ce && (Ae.rotation = r), te = !0)), ie && (r = ie(Ae.y), r !== Ae.y && (Ae.y = r), te = !0)), te && nt(!0), e || (Ae.deltaX = Ae.x - i, Ae.deltaY = Ae.y - a, de(Ae, "throwupdate", "onThrowUpdate"))
                        },
                        it = function() {
                            var e, t, o, r;
                            v = !1, s ? (s.calibrate(), Ae.minX = L = -s.maxScrollLeft(), Ae.minY = k = -s.maxScrollTop(), Ae.maxX = T = Ae.maxY = P = 0, v = !0) : a.bounds && (e = ce(a.bounds, n.parentNode), Ce ? (Ae.minX = L = e.left, Ae.maxX = T = e.left + e.width, Ae.minY = k = Ae.maxY = P = 0) : void 0 !== a.bounds.maxX || void 0 !== a.bounds.maxY ? (e = a.bounds, Ae.minX = L = e.minX, Ae.minY = k = e.minY, Ae.maxX = T = e.maxX, Ae.maxY = P = e.maxY) : (t = ce(n, n.parentNode), Ae.minX = L = se(n, Me) + e.left - t.left, Ae.minY = k = se(n, Ye) + e.top - t.top, Ae.maxX = T = L + (e.width - t.width), Ae.maxY = P = k + (e.height - t.height)), L > T && (Ae.minX = T, Ae.maxX = T = L, L = Ae.minX), k > P && (Ae.minY = P, Ae.maxY = P = k, k = Ae.minY), Ce && (Ae.minRotation = L, Ae.maxRotation = T), v = !0), a.liveSnap && (o = a.liveSnap === !0 ? a.snap || {} : a.liveSnap, r = o instanceof Array || "function" == typeof o, Ce ? (re = ut(r ? o : o.rotation, L, T, 1), ie = null) : o.points ? ae = ht(r ? o : o.points, L, T, k, P, o.radius, s ? -1 : 1) : (Pe && (re = ut(r ? o : o.x || o.left || o.scrollLeft, L, T, s ? -1 : 1)), _e && (ie = ut(r ? o : o.y || o.top || o.scrollTop, k, P, s ? -1 : 1))))
                        },
                        at = function() {
                            Ae.isThrowing = !1, de(Ae, "throwcomplete", "onThrowComplete")
                        },
                        lt = function() {
                            Ae.isThrowing = !1
                        },
                        st = function(e, t) {
                            var o, r, l, d;
                            e && i ? (e === !0 && (o = a.snap || a.liveSnap || {}, r = o instanceof Array || "function" == typeof o, e = {
                                resistance: (a.throwResistance || a.resistance || 1e3) / (Ce ? 10 : 1)
                            }, Ce ? e.rotation = Fe(Ae, r ? o : o.rotation, T, L, 1, t) : (Pe && (e[Me] = Fe(Ae, r ? o : o.points || o.x || o.left || o.scrollLeft, T, L, s ? -1 : 1, t || "x" === Ae.lockedAxis)), _e && (e[Ye] = Fe(Ae, r ? o : o.points || o.y || o.top || o.scrollTop, P, k, s ? -1 : 1, t || "y" === Ae.lockedAxis)), (o.points || o instanceof Array && "object" == typeof o[0]) && (e.linkedProps = Me + "," + Ye, e.radius = o.radius))), Ae.isThrowing = !0, d = isNaN(a.overshootTolerance) ? 1 === a.edgeResistance ? 0 : 1 - Ae.edgeResistance + .2 : a.overshootTolerance, Ae.tween = l = i.to(s || n, {
                                throwProps: e,
                                data: "_draggable",
                                ease: a.ease || x.Power3.easeOut,
                                onComplete: at,
                                onOverwrite: lt,
                                onUpdate: a.fastMode ? de : rt,
                                onUpdateParams: a.fastMode ? [Ae, "onthrowupdate", "onThrowUpdate"] : o && o.radius ? [!1, !0] : S
                            }, isNaN(a.maxDuration) ? 2 : a.maxDuration, isNaN(a.minDuration) ? 0 === d || "object" == typeof e && e.resistance > 1e3 ? 0 : .5 : a.minDuration, d), a.fastMode || (s && (s._suspendTransforms = !0), l.render(l.duration(), !0, !0), rt(!0, !0), Ae.endX = Ae.x, Ae.endY = Ae.y, Ce && (Ae.endRotation = Ae.x), l.play(0), rt(!0, !0), s && (s._suspendTransforms = !1))) : v && Ae.applyBounds()
                        },
                        dt = function(e) {
                            var t, o, r, i, a, l, s, f, p, u = pe || [1, 0, 0, 1, 0, 0];
                            pe = Ne(n.parentNode, !0), e && Ae.isPressed && u.join(",") !== pe.join(",") && (t = u[0], o = u[1], r = u[2], i = u[3], a = u[4], l = u[5], s = t * i - o * r, f = d * (i / s) + c * (-r / s) + (r * l - i * a) / s, p = d * (-o / s) + c * (t / s) + -(t * l - o * a) / s, c = f * pe[1] + p * pe[3] + pe[5], d = f * pe[0] + p * pe[2] + pe[4]), pe[1] || pe[2] || 1 != pe[0] || 1 != pe[3] || 0 != pe[4] || 0 != pe[5] || (pe = null)
                        },
                        ct = function() {
                            var e = 1 - Ae.edgeResistance;
                            dt(!1), pe && (d = Ae.pointerX * pe[0] + Ae.pointerY * pe[2] + pe[4], c = Ae.pointerX * pe[1] + Ae.pointerY * pe[3] + pe[5]), te && (yt(Ae.pointerX, Ae.pointerY), nt(!0)), s ? (it(), y = s.top(), f = s.left()) : (ft() ? (rt(!0, !0), it()) : Ae.applyBounds(), Ce ? (q = Ae.rotationOrigin = Xe(n, {
                                x: 0,
                                y: 0
                            }), rt(!0, !0), f = Ae.x, y = Ae.y = Math.atan2(q.y - Ae.pointerY, Ae.pointerX - q.x) * C) : (he = n.parentNode ? n.parentNode.scrollTop || 0 : 0, ge = n.parentNode ? n.parentNode.scrollLeft || 0 : 0, y = se(n, Ye), f = se(n, Me))), v && e && (f > T ? f = T + (f - T) / e : L > f && (f = L - (L - f) / e), Ce || (y > P ? y = P + (y - P) / e : k > y && (y = k - (k - y) / e))), Ae.startX = f, Ae.startY = y
                        },
                        ft = function() {
                            return Ae.tween && Ae.tween.isActive()
                        },
                        pt = function() {
                            !Y.parentNode || ft() || Ae.isDragging || Y.parentNode.removeChild(Y)
                        },
                        ut = function(e, t, o, n) {
                            return "function" == typeof e ? function(r) {
                                var i = Ae.isPressed ? 1 - Ae.edgeResistance : 1;
                                return e.call(Ae, r > o ? o + (r - o) * i : t > r ? t + (r - t) * i : r) * n
                            } : e instanceof Array ? function(n) {
                                for (var r, i, a = e.length, l = 0, s = M; --a > -1;) r = e[a], i = r - n, 0 > i && (i = -i), s > i && r >= t && o >= r && (l = a, s = i);
                                return e[l]
                            } : isNaN(e) ? function(e) {
                                return e
                            } : function() {
                        ...
                        ht = function(e, t, o, n, r, i, a) {
                            return i = i && M > i ? i * i : M, "function" == typeof e ? function(l) {
                                var s, d, c, f = Ae.isPressed ? 1 - Ae.edgeResistance : 1,
                                    p = l.x,
                                    u = l.y;
                                return l.x = p = p > o ? o + (p - o) * f : t > p ? t + (p - t) * f : p, l.y = u = u > r ? r + (u - r) * f : n > u ? n + (u - n) * f : u, s = e.call(Ae, l), s !== l && (l.x = s.x, l.y = s.y), 1 !== a && (l.x *= a, l.y *= a), M > i && (d = l.x - p, c = l.y - u, d * d + c * c > i && (l.x = p, l.y = u)), l
                            } : e instanceof Array ? function(t) {
                                for (var o, n, r, a, l = e.length, s = 0, d = M; --l > -1;) r = e[l], o = r.x - t.x, n = r.y - t.y, a = o * o + n * n, d > a && (s = l, d = a);
                                return i >= d ? e[s] : t
                            } : function(e) {
                                return e
                            }
                        ...
                        gt = function(e, o) {
                            var r;
                            if (l && !Ae.isPressed && e && ("mousedown" !== e.type && "pointerdown" !== e.type || o || !(N() - tt < 30) || !Ee[Ae.pointerEvent.type])) {
                                if (ue = ft(), Ae.pointerEvent = e, Ee[e.type] ? (fe = -1 !== e.type.indexOf("touch") ? e.currentTarget || e.target : m, Oe(fe, "touchend", vt), Oe(fe, "touchmove", xt), Oe(fe, "touchcancel", vt), Oe(m, "touchstart", We)) : (fe = null, Oe(m, "mousemove", xt)), ve = null, Oe(m, "mouseup", vt), e && e.target && Oe(e.target, "mouseup", vt), le = et.call(Ae, e.target) && !a.dragClickables && !o) return Oe(e.target, "change", vt), de(Ae, "press", "onPress"), void Ve(Ie, !0);
                                if (ye = !(!fe || Pe === _e || Ae.vars.allowNativeTouchScrolling === !1) && (Pe ? "y" : "x"), X ? e = J(e, !0) : ye || Ae.allowEventDefault || (e.preventDefault(), e.preventManipulation && e.preventManipulation()), e.changedTouches ? (e = z = e.changedTouches[0], U = e.identifier) : e.pointerId ? U = e.pointerId : z = U = null, E++, V(nt), c = Ae.pointerY = e.pageY, d = Ae.pointerX = e.pageX, (ye || Ae.autoScroll) && Q(n.parentNode), !n.parentNode || !Ae.autoScroll || s || Ce || !n.parentNode._gsMaxScrollX || Y.parentNode || n.getBBox || (Y.style.width = n.parentNode.scrollWidth + "px", n.parentNode.appendChild(Y)), ct(), Ae.tween && Ae.tween.kill(), Ae.isThrowing = !1, t.killTweensOf(s || n, !0, ze), s && t.killTweensOf(n, !0, {
                                        scrollTo: 1
                                    }), Ae.tween = Ae.lockedAxis = null, (a.zIndexBoost || !Ce && !s && a.zIndexBoost !== !1) && (n.style.zIndex = je.zIndex++), Ae.isPressed = !0, b = !(!a.onDrag && !Ae._listeners.drag), !Ce)
                                    for (r = Ie.length; --r > -1;) oe(Ie[r], "cursor", a.cursor || "move");
                                de(Ae, "press", "onPress")
                            }
                        },
                        xt = function(e) {
                            var t, o, n, i, a, s, f = e;
                            if (l && !r && Ae.isPressed && e) {
                                if (Ae.pointerEvent = e, t = e.changedTouches) {
                                    if (e = t[0], e !== z && e.identifier !== U) {
                                        for (i = t.length; --i > -1 && (e = t[i]).identifier !== U;);
                                        if (0 > i) return
                                    }
                                } else if (e.pointerId && U && e.pointerId !== U) return;
                                if (X) e = J(e, !0);
                                else {
                                    if (fe && ye && !ve && (o = e.pageX, n = e.pageY, pe && (i = o * pe[0] + n * pe[2] + pe[4], n = o * pe[1] + n * pe[3] + pe[5], o = i), a = Math.abs(o - d), s = Math.abs(n - c), (a !== s && (a > De || s > De) || O && ye === ve) && (ve = a > s && Pe ? "x" : "y", Ae.vars.lockAxisOnTouchScroll !== !1 && (Ae.lockedAxis = "x" === ve ? "y" : "x", "function" == typeof Ae.vars.onLockAxis && Ae.vars.onLockAxis.call(Ae, f)), O && ye === ve))) return void vt(f);
                                    Ae.allowEventDefault || ye && (!ve || ye === ve) || f.cancelable === !1 || (f.preventDefault(), f.preventManipulation && f.preventManipulation())
                                }
                                Ae.autoScroll && ($e = !0), yt(e.pageX, e.pageY)
                            }
                        },
                        yt = function(e, t) {
                            var o, n, r, i, a, l, s = 1 - Ae.dragResistance,
                                p = 1 - Ae.edgeResistance;
                            Ae.pointerX = e, Ae.pointerY = t, Ce ? (i = Math.atan2(q.y - t, e - q.x) * C, a = Ae.y - i, a > 180 ? (y -= 360, Ae.y = i) : -180 > a && (y += 360, Ae.y = i), Ae.x !== f || Math.abs(y - i) > De ? (Ae.y = i, r = f + (y - i) * s) : r = f) : (pe && (l = e * pe[0] + t * pe[2] + pe[4], t = e * pe[1] + t * pe[3] + pe[5], e = l), n = t - c, o = e - d, De > n && n > -De && (n = 0), De > o && o > -De && (o = 0), (Ae.lockAxis || Ae.lockedAxis) && (o || n) && (l = Ae.lockedAxis, l || (Ae.lockedAxis = l = Pe && Math.abs(o) > Math.abs(n) ? "y" : _e ? "x" : null, l && "function" == typeof Ae.vars.onLockAxis && Ae.vars.onLockAxis.call(Ae, Ae.pointerEvent)), "y" === l ? n = 0 : "x" === l && (o = 0)), r = f + o * s, i = y + n * s), (re || ie || ae) && (Ae.x !== r || Ae.y !== i && !Ce) ? (ae && (R.x = r, R.y = i, l = ae(R), r = l.x, i = l.y), re && (r = re(r)), ie && (i = ie(i))) : v && (r > T ? r = T + (r - T) * p : L > r && (r = L + (r - L) * p), Ce || (i > P ? i = P + (i - P) * p : k > i && (i = k + (i - k) * p))), Ce || pe || (r = Math.round(r), i = Math.round(i)), (Ae.x !== r || Ae.y !== i && !Ce) && (Ce ? (Ae.endRotation = Ae.x = Ae.endX = r, te = !0) : (_e && (Ae.y = Ae.endY = i, te = !0), Pe && (Ae.x = Ae.endX = r, te = !0)), !Ae.isDragging && Ae.isPressed && (Ae.isDragging = !0, de(Ae, "dragstart", "onDragStart")))
                        },
                        vt = function(e, o) {
                            if (l && Ae.isPressed && (!e || null == U || o || !(e.pointerId && e.pointerId !== U || e.changedTouches && !Re(e.changedTouches, U)))) {
                                Ae.isPressed = !1;
                                var r, i, s, d, c, f = e,
                                    p = Ae.isDragging,
                                    u = t.delayedCall(.001, pt);
                                if (fe ? (Be(fe, "touchend", vt), Be(fe, "touchmove", xt), Be(fe, "touchcancel", vt), Be(m, "touchstart", We)) : Be(m, "mousemove", xt), Be(m, "mouseup", vt), e && e.target && Be(e.target, "mouseup", vt), te = !1, le) return e && (Be(e.target, "change", vt), Ae.pointerEvent = f), Ve(Ie, !1), de(Ae, "release", "onRelease"), de(Ae, "click", "onClick"), void(le = !1);
                                if (I(nt), !Ce)
                                    for (i = Ie.length; --i > -1;) oe(Ie[i], "cursor", a.cursor || "move");
                                if (p && (Ue = B = N(), Ae.isDragging = !1), E--, e) {
                                    if (X && (e = J(e, !1)), r = e.changedTouches, r && (e = r[0], e !== z && e.identifier !== U)) {
                                        for (i = r.length; --i > -1 && (e = r[i]).identifier !== U;);
                                        if (0 > i) return
                                    }
                                    Ae.pointerEvent = f, Ae.pointerX = e.pageX, Ae.pointerY = e.pageY
                                }
                                return f && !p ? (ue && (a.snap || a.bounds) && st(a.throwProps), de(Ae, "release", "onRelease"), O && "touchmove" === f.type || -1 !== f.type.indexOf("cancel") || (de(Ae, "click", "onClick"), N() - tt < 300 && de(Ae, "doubleclick", "onDoubleClick"), d = f.target || f.srcElement || n, tt = N(), c = function() {
                                    tt !== be && Ae.enabled() && !Ae.isPressed && (d.click ? d.click() : m.createEvent && (s = m.createEvent("MouseEvents"), s.initMouseEvent("click", !0, !0, window, 1, Ae.pointerEvent.screenX, Ae.pointerEvent.screenY, Ae.pointerX, Ae.pointerY, !1, !1, !1, !1, 0, null), d.dispatchEvent(s)))
                                }, O || f.defaultPrevented || t.delayedCall(1e-5, c))) : (st(a.throwProps), X || Ae.allowEventDefault || !f || !a.dragClickables && et.call(Ae, f.target) || !p || ye && (!ve || ye !== ve) || f.cancelable === !1 || (f.preventDefault(), f.preventManipulation && f.preventManipulation()), de(Ae, "release", "onRelease")), ft() && u.duration(Ae.tween.duration()), p && de(Ae, "dragend", "onDragEnd"), !0
                            }
                        },
                        mt = function(e) {
                            if (e && Ae.isDragging && !s) {
                                var t = e.target || e.srcElement || n.parentNode,
                                    o = t.scrollLeft - t._gsScrollX,
                                    r = t.scrollTop - t._gsScrollY;
                                (o || r) && (pe ? (d -= o * pe[0] + r * pe[2], c -= r * pe[3] + o * pe[1]) : (d -= o, c -= r), t._gsScrollX += o, t._gsScrollY += r, yt(Ae.pointerX, Ae.pointerY))
                            }
                        },
                        wt = function(e) {
                            var t = N(),
                                ...
                                r = o && be === tt,
                                i = !!e.preventDefault,
                                a = Ae.pointerEvent && Ae.pointerEvent.defaultPrevented,
                                l = o && Te === tt,
                                s = e.isTrusted || null == e.isTrusted && o && r;
                            return i && (r || n && Ae.vars.suppressClickOnDrag !== !1) && e.stopImmediatePropagation(), !o || Ae.pointerEvent && Ae.pointerEvent.defaultPrevented || r && s === l ? void((Ae.isPressed || n || o) && (i ? s && e.detail && o && !a || (e.preventDefault(), e.preventManipulation && e.preventManipulation()) : e.returnValue = !1)) : (s && r && (Te = tt), void(be = tt))
                        },
                        bt = function(e) {
                            return pe ? {
                                x: e.x * pe[0] + e.y * pe[2] + pe[4],
                                y: e.x * pe[1] + e.y * pe[3] + pe[5]
                            } : {
                                x: e.x,
                                y: e.y
                            }
                        };
                    ne = je.get(this.target), ne && ne.kill(), this.startDrag = function(e, t) {
                        var o, r, i, a;
                        gt(e || Ae.pointerEvent, !0), t && !Ae.hitTest(e || Ae.pointerEvent) && (o = Ke(e || Ae.pointerEvent), r = Ke(n), i = bt({
                            x: o.left + o.width / 2,
                            y: o.top + o.height / 2
                        }), a = bt({
                            x: r.left + r.width / 2,
                            y: r.top + r.height / 2
                        }), d -= i.x - a.x, c -= i.y - a.y), Ae.isDragging || (Ae.isDragging = !0,
                            de(Ae, "dragstart", "onDragStart"))
                    }, this.drag = xt, this.endDrag = function(e) {
                        vt(e || Ae.pointerEvent, !0)
                    }, this.timeSinceDrag = function() {
                        return Ae.isDragging ? 0 : (N() - Ue) / 1e3
                    }, this.timeSinceClick = function() {
                        return (N() - tt) / 1e3
                    }, this.hitTest = function(e, t) {
                        return je.hitTest(Ae.target, e, t)
                    }, this.getDirection = function(e, t) {
                        var o, n, r, a, l, s, d = "velocity" === e && i ? e : "object" != typeof e || Ce ? "start" : "element";
                        return "element" === d && (l = Ke(Ae.target), s = Ke(e)), o = "start" === d ? Ae.x - f : "velocity" === d ? i.getVelocity(this.target, Me) : l.left + l.width / 2 - (s.left + s.width / 2), Ce ? 0 > o ? "counter-clockwise" : "clockwise" : (t = t || 2, n = "start" === d ? Ae.y - y : "velocity" === d ? i.getVelocity(this.target, Ye) : l.top + l.height / 2 - (s.top + s.height / 2), r = Math.abs(o / n), a = 1 / t > r ? "" : 0 > o ? "left" : "right", t > r && ("" !== a && (a += "-"), a += 0 > n ? "up" : "down"), a)
                    }, this.applyBounds = function(e) {
                        var t, o, r, i, l, s;
                        if (e && a.bounds !== e) return a.bounds = e, Ae.update(!0);
                        if (rt(!0), it(), v) {
                            if (t = Ae.x, o = Ae.y, t > T ? t = T : L > t && (t = L), o > P ? o = P : k > o && (o = k), (Ae.x !== t || Ae.y !== o) && (r = !0, Ae.x = Ae.endX = t, Ce ? Ae.endRotation = t : Ae.y = Ae.endY = o, te = !0, nt(!0), Ae.autoScroll && !Ae.isDragging))
                                for (Q(n.parentNode), i = n, A.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != w.scrollTop ? w.scrollTop : m.body.scrollTop, A.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != w.scrollLeft ? w.scrollLeft : m.body.scrollLeft; i && !s;) s = Z(i.parentNode), l = s ? A : i.parentNode, _e && l.scrollTop > l._gsMaxScrollY && (l.scrollTop = l._gsMaxScrollY), Pe && l.scrollLeft > l._gsMaxScrollX && (l.scrollLeft = l._gsMaxScrollX), i = l;
                            Ae.isThrowing && (r || Ae.endX > T || Ae.endX < L || Ae.endY > P || Ae.endY < k) && st(a.throwProps, r)
                        }
                        return Ae
                    }, this.update = function(e, t, o) {
                        var r = Ae.x,
                            i = Ae.y;
                        return dt(!t), e ? Ae.applyBounds() : (te && o && nt(!0), rt(!0)), t && (yt(Ae.pointerX, Ae.pointerY), te && nt(!0)), Ae.isPressed && !t && (Pe && Math.abs(r - Ae.x) > .01 || _e && Math.abs(i - Ae.y) > .01 && !Ce) && ct(), Ae.autoScroll && (Q(n.parentNode), $e = Ae.isDragging, nt(!0)), Ae.autoScroll && (K(n, mt), $(n, mt)), Ae
                    }, this.enable = function(e) {
                        var r, d, c;
                        if ("soft" !== e) {
                            for (d = Ie.length; --d > -1;) c = Ie[d], Oe(c, "mousedown", gt), Oe(c, "touchstart", gt), Oe(c, "click", wt, !0), Ce || oe(c, "cursor", a.cursor || "move"), oe(c, "touchCallout", "none"), oe(c, "touchAction", Pe === _e ? "none" : Pe ? "pan-y" : "pan-x"), me(c) && oe(c.ownerSVGElement || c, "touchAction", Pe === _e ? "none" : Pe ? "pan-y" : "pan-x"), this.vars.allowContextMenu || Oe(c, "contextmenu", ot);
                            Ve(Ie, !1)
                        }
                        return $(n, mt), l = !0, i && "soft" !== e && i.track(s || n, Le ? "x,y" : Ce ? "rotation" : "top,left"), s && s.enable(), n._gsDragID = r = "d" + D++, _[r] = this, s && (s.element._gsDragID = r), t.set(n, {
                            x: "+=0",
                            overwrite: !1,
                            data: "_draggable"
                        }), xe = {
                            t: n,
                            data: X ? G : n._gsTransform,
                            tween: {},
                            setRatio: X ? function() {
                                t.set(n, H)
                        ...
                        var t, o, r = Ae.isDragging;
                        if (!Ce)
                            for (t = Ie.length; --t > -1;) oe(Ie[t], "cursor", null);
                        if ("soft" !== e) {
                            for (t = Ie.length; --t > -1;) o = Ie[t], oe(o, "touchCallout", null), oe(o, "touchAction", null), Be(o, "mousedown", gt), Be(o, "touchstart", gt), Be(o, "click", wt), Be(o, "contextmenu", ot);
                            Ve(Ie, !0), fe && (Be(fe, "touchcancel", vt), Be(fe, "touchend", vt), Be(fe, "touchmove", xt)), Be(m, "mouseup", vt), Be(m, "mousemove", xt)
                        }
                        return K(n, mt), l = !1, i && "soft" !== e && i.untrack(s || n, Le ? "x,y" : Ce ? "rotation" : "top,left"), s && s.disable(), I(nt), Ae.isDragging = Ae.isPressed = le = !1, r && de(Ae, "dragend", "onDragEnd"), Ae
                    }, this.enabled = function(e, t) {
                        return arguments.length ? e ? Ae.enable(t) : Ae.disable(t) : l
                    }, this.kill = function() {
                        return Ae.isThrowing = !1, t.killTweensOf(s || n, !0, ze), Ae.disable(), delete _[n._gsDragID], Ae
                    }, -1 !== Se.indexOf("scroll") && (s = this.scrollProxy = new Ge(n, j({
                        onKill: function() {
                            Ae.isPressed && vt(null)
                        }
                    }, a)), n.style.overflowY = _e && !ke ? "auto" : "hidden", n.style.overflowX = Pe && !ke ? "auto" : "hidden", n = s.content), a.force3D !== !1 && t.set(n, {
                        force3D: !0
                    }), Ce ? ze.rotation = 1 : (Pe && (ze[Me] = 1), _e && (ze[Ye] = 1)), Ce ? (H = g, G = H.css, H.overwrite = !1) : Le && (H = Pe && _e ? p : Pe ? u : h, G = H.css, H.overwrite = !1), this.enable()
                },
                ze = je.prototype = new e;
            ze.constructor = je, ze.pointerX = ze.pointerY = ze.startX = ze.startY = ze.deltaX = ze.deltaY = 0, ze.isDragging = ze.isPressed = !1, je.version = "0.16.1", je.zIndex = 1e3, Oe(m, "touchcancel", function() {}), Oe(m, "contextmenu", function(e) {
                var t;
                for (t in _) _[t].isPressed && _[t].endDrag()
            }), je.create = function(e, o) {
                "string" == typeof e && (e = t.selector(e));
                for (var n = e && 0 !== e.length ? _e(e) ? De(e) : [e] : [], r = n.length; --r > -1;) n[r] = new je(n[r], o);
                return n
            }, je.get = function(e) {
                return _[(ee(e) || {})._gsDragID]
            ...
            var Ue = {},
                $e = function(e) {
                    var t, o, n = 0,
                        r = 0;
                    for (e = ee(e), t = e.offsetWidth, o = e.offsetHeight; e;) n += e.offsetTop, r += e.offsetLeft, e = e.offsetParent;
                    return {
                        top: n,
                        left: r,
                        width: t,
                ...
                Ke = function(e, t) {
                    if (e === window) return Ue.left = Ue.top = 0, Ue.width = Ue.right = w.clientWidth || e.innerWidth || m.body.clientWidth || 0, Ue.height = Ue.bottom = (e.innerHeight || 0) - 20 < w.clientHeight ? w.clientHeight : e.innerHeight || m.body.clientHeight || 0, Ue;
                    var o = e.pageX !== t ? {
                        left: e.pageX - U(),
                        top: e.pageY - z(),
                        right: e.pageX - U() + 1,
                        bottom: e.pageY - z() + 1
                    } : e.nodeType || e.left === t || e.top === t ? X ? $e(e) : ee(e).getBoundingClientRect() : e;
            ...
            return je.hitTest = function(e, t, o) {
                if (e === t) return !1;
                var n, r, i, a = Ke(e),
                    l = Ke(t),
                    s = l.left > a.right || l.right < a.left || l.top > a.bottom || l.bottom < a.top;
                return s || !o ? !s : (i = -1 !== (o + "").indexOf("%"), o = parseFloat(o) || 0, n = {
                    left: Math.max(a.left, l.left),
                    top: Math.max(a.top, l.top)
                }, n.width = Math.min(a.right, l.right) - n.left, n.height = Math.min(a.bottom, l.bottom) - n.top, !(n.width < 0 || n.height < 0) && (i ? (o *= .01, r = n.width * n.height, r >= a.width * a.height * o || r >= l.width * l.height * o) : n.width > o && n.height > o))
            }, Y.style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;", je
        }, !0)
    ...
    function(e) {
        ...
        "undefined" != typeof module && module.exports ? (require("../TweenLite.min.js"), require("../plugins/CSSPlugin.min.js"), module.exports = t()) : "function" == typeof define && define.amd && define(["TweenLite", "CSSPlugin"], t)
    }("Draggable");
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        "use strict";
        _gsScope._gsDefine("easing.CustomEase", ["easing.Ease"], function(e) {
            var t = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
                ...
                a = function(e, t, i, n, s, o, r, h, u, c, l) {
                    var f, g = (e + i) / 2,
                        p = (t + n) / 2,
                        x = (i + s) / 2,
                        d = (n + o) / 2,
                        ...
                        k = r - e,
                        C = h - t,
                        z = Math.abs((i - r) * C - (n - h) * k),
                        D = Math.abs((s - r) * C - (o - h) * k);
                    return c || (c = [{
                        x: e,
                        y: t
                    }, {
                        x: r,
                        y: h
                    }], l = 1), c.splice(l || c.length - 1, 0, {
                        x: M,
                        y: b
                    }), (z + D) * (z + D) > u * (k * k + C * C) && (f = c.length, a(e, t, g, p, S, _, M, b, u, c, l), a(M, b, v, w, y, m, r, h, u, c, l + 1 + (c.length - f))), c
                },
                r = function(e) {
                    var t, s, a, r, h, u, c, l, f, g, p, x = (e + "").replace(n, function(e) {
                            var t = +e;
                        ...
                        _ = 2;
                    for (t = 0; S > t; t++)
                        if (f = r, isNaN(x[t]) ? (r = x[t].toUpperCase(), h = r !== x[t]) : t--, s = +x[t + 1], a = +x[t + 2], h && (s += y, a += m), t || (c = s, l = a), "M" === r) u && u.length < 8 && (d.length -= 1, _ = 0), y = c = s, m = l = a, u = [s, a], _ = 2, d.push(u), t += 2, r = "L";
                        else if ("C" === r) u || (u = [0, 0]), u[_++] = s, u[_++] = a, h || (y = m = 0), u[_++] = y + 1 * x[t + 3], u[_++] = m + 1 * x[t + 4], u[_++] = y += 1 * x[t + 5], u[_++] = m += 1 * x[t + 6], t += 6;
                    else if ("S" === r) "C" === f || "S" === f ? (g = y - u[_ - 4], p = m - u[_ - 3], u[_++] = y + g, u[_++] = m + p) : (u[_++] = y, u[_++] = m), u[_++] = s, u[_++] = a, h || (y = m = 0), u[_++] = y += 1 * x[t + 3], u[_++] = m += 1 * x[t + 4], t += 4;
                    else {
                        if ("L" !== r && "Z" !== r) throw o;
                        "Z" === r && (s = c, a = l, u.closed = !0), ("L" === r || Math.abs(y - s) > .5 || Math.abs(m - a) > .5) && (u[_++] = y + (s - y) / 3, u[_++] = m + (a - m) / 3, u[_++] = y + 2 * (s - y) / 3, u[_++] = m + 2 * (a - m) / 3, u[_++] = s, u[_++] = a, "L" === r && (t += 2)), y = s, m = a
                    }
                    return d[0]
                },
                h = function(e) {
                ...
                u = function(e, t, i) {
                    ...
                    var n, s = -1 * +e[0],
                        ...
                        a = e.length,
                        r = 1 / (+e[a - 2] + s),
                        u = -t || (Math.abs(+e[a - 1] - +e[1]) < .01 * (+e[a - 2] - +e[0]) ? h(e) + o : +e[a - 1] + o);
                    for (u = u ? 1 / u : -r, n = 0; a > n; n += 2) e[n] = (+e[n] + s) * r, e[n + 1] = (+e[n + 1] + o) * u
                },
                c = function(e) {
                ...
                l = function(t, i, n) {
                    this._calcEnd = !0, this.id = t, t && (e.map[t] = this), this.getRatio = c, this.setData(i, n)
                },
                f = l.prototype = new e;
            return f.constructor = l, f.setData = function(e, i) {
                e = e || "0,0,1,1";
                var n, h, c, l, f, g, p, x, d, y, m = e.match(t),
                    S = 1,
                    _ = [];
                if (i = i || {}, y = i.precision || 1, this.data = e, this.lookup = [], this.points = _, this.fast = 1 >= y, (s.test(e) || -1 !== e.indexOf("M") && -1 === e.indexOf("C")) && (m = r(e)), n = m.length, 4 === n) m.unshift(0, 0), m.push(1, 1), n = 8;
                else if ((n - 2) % 6) throw o;
                for ((0 !== +m[0] || 1 !== +m[n - 2]) && u(m, i.height, i.originY), this.rawBezier = m, l = 2; n > l; l += 6) h = {
                    x: +m[l - 2],
                    y: +m[l - 1]
                }, c = {
                    x: +m[l + 4],
                    y: +m[l + 5]
                }, _.push(h, c), a(h.x, h.y, +m[l], +m[l + 1], +m[l + 2], +m[l + 3], c.x, c.y, 1 / (2e5 * y), _, _.length - 1);
                for (n = _.length, l = 0; n > l; l++) p = _[l], x = _[l - 1] || p, p.x > x.x || x.y !== p.y && x.x === p.x || p === x ? (x.cx = p.x - x.x, x.cy = p.y - x.y, x.n = p, x.nx = p.x, this.fast && l > 1 && Math.abs(x.cy / x.cx - _[l - 2].cy / _[l - 2].cx) > 2 && (this.fast = !1), x.cx < S && (x.cx ? S = x.cx : (x.cx = .001, l === n - 1 && (x.x -= .001, S = Math.min(S, .001), this.fast = !1)))) : (_.splice(l--, 1), n--);
                if (n = 1 / S + 1 | 0, this.l = n, f = 1 / n, g = 0, p = _[0], this.fast) {
                    for (l = 0; n > l; l++) d = l * f, p.nx < d && (p = _[++g]), h = p.y + (d - p.x) / p.cx * p.cy, this.lookup[l] = {
                        x: d,
                        cx: f,
                        y: h,
                        cy: 0,
                    ...
                    this.lookup[n - 1].cy = _[_.length - 1].y - h
                } else {
                    for (l = 0; n > l; l++) p.nx < l * f && (p = _[++g]), this.lookup[l] = p;
                    g < _.length - 1 && (this.lookup[l - 1] = _[_.length - 2])
                }
                return this._calcEnd = 1 !== _[_.length - 1].y || 0 !== _[0].y, this
            }, f.getRatio = c, f.getSVGData = function(e) {
                return l.getSVGData(this, e)
            }, l.create = function(e, t, i) {
                return new l(e, t, i)
            }, l.version = "0.2.2", l.bezierToPoints = a, l.get = function(t) {
                return e.map[t]
            }, l.getSVGData = function(t, i) {
                i = i || {};
                var n, s, o, a, r, h, u, c, l, f, g = 1e3,
                    p = i.width || 100,
                    x = i.height || 100,
                    d = i.x || 0,
                    y = (i.y || 0) + x,
                    m = i.path;
                if (i.invert && (x = -x, y = 0), t = t.getRatio ? t : e.map[t] || console.log("No ease found: ", t), t.rawBezier) {
                    for (n = [], u = t.rawBezier.length, o = 0; u > o; o += 2) n.push(((d + t.rawBezier[o] * p) * g | 0) / g + "," + ((y + t.rawBezier[o + 1] * -x) * g | 0) / g);
                    n[0] = "M" + n[0], n[1] = "C" + n[1]
                } else
                    for (n = ["M" + d + "," + y], u = Math.max(5, 200 * (i.precision || 1)), a = 1 / u, u += 2, c = 5 / u, l = ((d + a * p) * g | 0) / g, f = ((y + t.getRatio(a) * -x) * g | 0) / g, s = (f - y) / (l - d), o = 2; u > o; o++) r = ((d + o * a * p) * g | 0) / g, h = ((y + t.getRatio(o * a) * -x) * g | 0) / g, (Math.abs((h - f) / (r - l) - s) > c || o === u - 1) && (n.push(l + "," + f), s = (h - f) / (r - l)), l = r, f = h;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var s = function(t) {
                    ...
                    n = function(t, e, s) {
                        i.call(this, t, e, s), this._cycle = 0, this._yoyo = this.vars.yoyo === !0 || !!this.vars.yoyoEase, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._repeat && this._uncache(!0), this.render = n.prototype.render
                    },
                    a = 1e-10,
                    o = i._internals,
                    l = o.isSelector,
                    ...
                    u = [];
                n.version = "2.0.1", _.constructor = n, _.kill()._gc = !1, n.killTweensOf = n.killDelayedCallsTo = i.killTweensOf, n.getTweensOf = i.getTweensOf, n.lagSmoothing = i.lagSmoothing, n.ticker = i.ticker, n.render = i.render, _.invalidate = function() {
                    ...
                    var r, n, l, h, _, u, f, c, p, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        v = this._duration,
                        T = this._rawPrevTime;
                    if (t >= d - 1e-7 && t >= 0 ? (this._totalTime = d, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = v, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (r = !0, n = "onComplete", s = s || this._timeline.autoRemoveChildren), 0 === v && (this._initted || !this.vars.lazy || s) && (this._startTime === this._timeline._duration && (t = 0), (0 > T || 0 >= t && t >= -1e-7 || T === a && "isPause" !== this.data) && T !== t && (s = !0, T > a && (n = "onReverseComplete")), this._rawPrevTime = c = !e || t || T === t ? t : a)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== g || 0 === v && T > 0) && (n = "onReverseComplete", r = this._reversed), 0 > t && (this._active = !1, 0 === v && (this._initted || !this.vars.lazy || s) && (T >= 0 && (s = !0), this._rawPrevTime = c = !e || t || T === t ? t : a)), this._initted || (s = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (h = v + this._repeatDelay, this._cycle = this._totalTime / h >> 0, 0 !== this._cycle && this._cycle === this._totalTime / h && t >= g && this._cycle--, this._time = this._totalTime - this._cycle * h, this._yoyo && 0 !== (1 & this._cycle) && (this._time = v - this._time, p = this._yoyoEase || this.vars.yoyoEase, p && (this._yoyoEase || (p !== !0 || this._initted ? this._yoyoEase = p = p === !0 ? this._ease : p instanceof Ease ? p : Ease.map[p] : (p = this.vars.ease, this._yoyoEase = p = p ? p instanceof Ease ? p : "function" == typeof p ? new Ease(p, this.vars.easeParams) : Ease.map[p] || i.defaultEase : i.defaultEase)), this.ratio = p ? 1 - p.getRatio((v - this._time) / v) : 0)), this._time > v ? this._time = v : this._time < 0 && (this._time = 0)), this._easeType && !p ? (_ = this._time / v, u = this._easeType, f = this._easePower, (1 === u || 3 === u && _ >= .5) && (_ = 1 - _), 3 === u && (_ *= 2), 1 === f ? _ *= _ : 2 === f ? _ *= _ * _ : 3 === f ? _ *= _ * _ * _ : 4 === f && (_ *= _ * _ * _ * _), 1 === u ? this.ratio = 1 - _ : 2 === u ? this.ratio = _ : this._time / v < .5 ? this.ratio = _ / 2 : this.ratio = 1 - _ / 2) : p || (this.ratio = this._ease.getRatio(this._time / v))), m === this._time && !s && y === this._cycle) return void(g !== this._totalTime && this._onUpdate && (e || this._callback("onUpdate")));
                    if (!this._initted) {
                        if (this._init(), !this._initted || this._gc) return;
                        if (!s && this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration)) return this._time = m, this._totalTime = g, this._rawPrevTime = T, this._cycle = y, o.lazyTweens.push(this), void(this._lazy = [t, e]);
                    ...
                    for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== m && t >= 0 && (this._active = !0), 0 === g && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, !0, s) : n || (n = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === v) && (e || this._callback("onStart"))), l = this._firstPT; l;) l.f ? l.t[l.p](l.c * this.ratio + l.s) : l.t[l.p] = l.c * this.ratio + l.s, l = l._next;
                ...
                var s = function(t) {
                    ...
                    m = s.prototype = new e;
                return s.version = "2.0.1", m.constructor = s, m.kill()._gc = m._forcingPlayhead = m._hasPause = !1, m.to = function(t, e, s, r) {
                    ...
                    if (this._time !== c && this._first || i || l || u) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== c && t > 0 && (this._active = !0), 0 === c && this.vars.onStart && (0 === this._time && this._duration || e || this._callback("onStart")), f = this._time, f >= c)
                ...
                var s = function(e) {
                    ...
                    _ = s.prototype = new t;
                return _.constructor = s, _.kill()._gc = !1, s.version = "2.0.1", _.invalidate = function() {
                    ...
                    if (p !== this._time && (t += this._time - p), t >= d - 1e-7 && t >= 0) this._locked || (this._totalTime = d, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (n = !0, h = "onComplete", _ = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > T || T === r) && T !== t && this._first && (_ = !0, T > r && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = m, t = m + 1e-4);
                        ...
                        if (t = this._time, t >= p || this._repeat && b !== this._cycle)
                    ...
                    if (!(this._time !== p && this._first || i || _ || f)) return void(g !== this._totalTime && this._onUpdate && (e || this._callback("onUpdate")));
                    if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== g && t > 0 && (this._active = !0), 0 === g && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), c = this._time, c >= p)
            ...
            function() {
                var t = 180 / Math.PI,
                    ...
                    h = function(t, r, n, a, o) {
                        var h, _, u, f, c, p, d, m, g, y, v, T, x, b = t.length - 1,
                            w = 0,
                            P = t[0].a;
                        for (h = 0; b > h; h++) c = t[w], _ = c.a, u = c.d, f = t[w + 1].d, o ? (v = e[h], T = i[h], x = (T + v) * r * .25 / (a ? .5 : s[h] || .5), p = u - (u - _) * (a ? .5 * r : 0 !== v ? x / v : 0), d = u + (f - u) * (a ? .5 * r : 0 !== T ? x / T : 0), m = u - (p + ((d - p) * (3 * v / (v + T) + .5) / 4 || 0))) : (p = u - (u - _) * r * .5, d = u + (f - u) * r * .5, m = u - (p + d) / 2), p += m, d += m, c.c = g = p, 0 !== h ? c.b = P : c.b = P = c.a + .6 * (c.c - c.a), c.da = u - _, c.ca = g - _, c.ba = P - _, n ? (y = l(_, P, g, u), t.splice(w, 1, y[0], y[1], y[2], y[3]), w += 4) : w++, P = d;
                        c = t[w], c.b = P, c.c = P + .4 * (c.d - P), c.da = c.d - c.a, c.ca = c.c - c.a, c.ba = P - c.a, n && (y = l(c.a, P, c.c, c.d), t.splice(w, 1, y[0], y[1], y[2], y[3]))
                    },
                    _ = function(t, s, r, n) {
                        var o, l, h, _, u, f, c = [];
                        if (n)
                            for (t = [n].concat(t), l = t.length; --l > -1;) "string" == typeof(f = t[l][s]) && "=" === f.charAt(1) && (t[l][s] = n[s] + Number(f.charAt(0) + f.substr(2)));
                        if (o = t.length - 2, 0 > o) return c[0] = new a(t[0][s], 0, 0, t[0][s]), c;
                    ...
                    u = function(t, n, a, l, u, f) {
                        var c, p, d, m, g, y, v, T, x = {},
                            b = [],
                            w = f || t[0];
                        u = "string" == typeof u ? "," + u + "," : o, null == n && (n = 1);
                        for (p in t[0]) b.push(p);
                        if (t.length > 1) {
                            for (T = t[t.length - 1], v = !0, c = b.length; --c > -1;)
                                if (p = b[c], Math.abs(w[p] - T[p]) > .05) {
                                    v = !1;
                                    break
                                } v && (t = t.concat(), f && t.unshift(f), t.push(t[1]), f = t[t.length - 3])
                        }
                        for (e.length = i.length = s.length = 0, c = b.length; --c > -1;) p = b[c], r[p] = -1 !== u.indexOf("," + p + ","), x[p] = _(t, p, r[p], f);
                        for (c = e.length; --c > -1;) e[c] = Math.sqrt(e[c]), i[c] = Math.sqrt(i[c]);
                        if (!l) {
                            for (c = b.length; --c > -1;)
                                if (r[p])
                                    for (d = x[b[c]],
                                        y = d.length - 1, m = 0; y > m; m++) g = d[m + 1].da / i[m] + d[m].da / e[m] || 0, s[m] = (s[m] || 0) + g * g;
                            for (c = s.length; --c > -1;) s[c] = Math.sqrt(s[c])
                        }
                        for (c = b.length, m = a ? 4 : 1; --c > -1;) p = b[c], d = x[p], h(d, n, a, l, r[p]), v && (d.splice(0, m), d.splice(d.length - m, m));
                        return x
                    },
                    f = function(t, e, i) {
                        e = e || "soft";
                        ...
                        for (h = y.length; --h > -1;) {
                            for (f = y[h], d[f] = l = [], c = 0, u = t.length, _ = 0; u > _; _++) s = null == i ? t[_][f] : "string" == typeof(p = t[_][f]) && "=" === p.charAt(1) ? i[f] + Number(p.charAt(0) + p.substr(2)) : Number(p), g && _ > 1 && u - 1 > _ && (l[c++] = (s + l[c - 2]) / 2), l[c++] = s;
                    ...
                    d = _gsScope._gsDefine.plugin({
                        ...
                        set: function(e) {
                            ...
                            if (this._autoRotate) {
                                ...
                                for (r = w.length; --r > -1;) n = w[r][2], x = w[r][3] || 0, b = w[r][4] === !0 ? 1 : t, a = this._beziers[w[r][0]], m = this._beziers[w[r][1]], a && m && (a = a[i], m = m[i], g = a.a + (a.b - a.a) * o, v = a.b + (a.c - a.b) * o, g += (v - g) * o, v += (a.c + (a.d - a.c) * o - v) * o, y = m.a + (m.b - m.a) * o, T = m.b + (m.c - m.b) * o, y += (T - y) * o, T += (m.c + (m.d - m.c) * o - T) * o, l = d ? Math.atan2(T - y, v - g) * b + x : this._initialRotations[r], this._mod[n] && (l = this._mod[n](l, p)), c[n] ? p[n](l) : p[n] = l)
                            }
                        }
                    }),
                    m = d.prototype;
                ...
                h.constructor = a, a.version = "1.20.5", a.API = 2, a.defaultTransformPerspective = 0, a.defaultSkewType = "compensated", a.defaultSmoothOrigin = !0, h = "px", a.suffixMap = {
                    top: h,
                    right: h,
                    bottom: h,
                    left: h,
                ...
                var _, u, f, c, p, d, m, g, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                    ...
                    Q = function(t, e) {
                        ...
                        return s >= 0 ? ($ = 3 === s ? "ms" : i[s], H = "-" + $.toLowerCase() + "-", $ + t) : null
                    },
                    ...
                    tt = V.convertToPixels = function(t, i, s, r, n) {
                        ...
                        if (c && (s = -s), p && (s *= 100), "lineHeight" !== i || r)
                            if ("%" === r && -1 !== i.indexOf("border")) o = s / 100 * (_ ? t.clientWidth : t.clientHeight);
                                ...
                                if (f.cssText = "border:0 solid red;position:" + J(t, "position") + ";line-height:0;", "%" !== r && u.appendChild && "v" !== r.charAt(0) && "rem" !== r) f[_ ? "borderLeftWidth" : "borderTopWidth"] = s + r;
                                else {
                                ...
                                u.appendChild(j), o = parseFloat(j[_ ? "offsetWidth" : "offsetHeight"]), u.removeChild(j), _ && "%" === r && a.cacheWidths !== !1 && (l = u._gsCache = u._gsCache || {}, l.time = h, l.width = o / s * 100), 0 !== o || n || (o = tt(t, i, s, r, !0))
                            }
                    ...
                    it = function(t, e) {
                        ...
                        if (e = e || K(t, null))
                            if (i = e.length)
                                for (; --i > -1;) r = e[i], (-1 === r.indexOf("-transform") || At === r) && (n[r.replace(R, C)] = e.getPropertyValue(r));
                            else
                                for (i in e)(-1 === i.indexOf("Transform") || Rt === i) && (n[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === n[i] && (n[i.replace(R, C)] = e[i]);
                        return W || (n.opacity = G(t)), s = Ut(t, e, !1), n.rotation = s.rotation, n.skewX = s.skewX, n.scaleX = s.scaleX, n.scaleY = s.scaleY, n.x = s.x, n.y = s.y, Mt && (n.z = s.z, n.rotationX = s.rotationX, n.rotationY = s.rotationY, n.scaleZ = s.scaleZ), n.filters && delete n.filters, n
                    },
                    ...
                    _t = function(t, e, i, s) {
                        ...
                        return "function" == typeof t && (t = t(g, m)), null == t ? o = e : "number" == typeof t ? o = t : (r = 360, n = t.split("_"), l = "=" === t.charAt(1), a = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(n[0].substr(2)) : parseFloat(n[0])) * (-1 === t.indexOf("rad") ? 1 : X) - (l ? 0 : e), n.length && (s && (s[i] = e + a), -1 !== t.indexOf("short") && (a %= r, a !== a % (r / 2) && (a = 0 > a ? a + r : a - r)), -1 !== t.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * r) % r - (a / r | 0) * r : -1 !== t.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * r) % r - (a / r | 0) * r)), o = e + a), h > o && o > -h && (o = 0), o
                    },
                    ut = {
                        aqua: [0, 255, 255],
                        lime: [0, 255, 0],
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                ...
                                if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ut[t]) i = ut[t];
                                    ...
                                    } else a = Number(i[0]) % 360 / 360, o = Number(i[1]) / 100, l = Number(i[2]) / 100, r = .5 >= l ? l * (o + 1) : l + o - l * o, s = 2 * l - r, i.length > 3 && (i[3] = Number(i[3])), i[0] = ft(a + 1 / 3, s, r), i[1] = ft(a, s, r), i[2] = ft(a - 1 / 3, s, r);
                    ...
                    pt = function(t, e) {
                        ...
                        for (i = 0; i < n.length; i++) s = n[i], r = t.substr(a, t.indexOf(s, a) - a), a += r.length + s.length, s = ct(s, e), 3 === s.length && s.push(1), o += r + (e ? "hsla(" + s[0] + "," + s[1] + "%," + s[2] + "%," + s[3] : "rgba(" + s.join(",")) + ")";
                        return o + t.substr(a)
                    },
                ...
                var mt = function(t, e, i, s) {
                        ...
                        return _ ? r = e ? function(t) {
                            ...
                            if (e = (t.match(dt) || [n])[0], f = t.split(e).join("").match(T) || [], c = f.length, _ > c--)
                    ...
                    yt = (V._setPluginRatio = function(t) {
                        ...
                        for (var e, i, s, r, n, a = this.data, o = a.proxy, l = a.firstMPT, h = 1e-6; l;) e = o[l.v], l.r ? e = l.r(e) : h > e && e > -h && (e = 0), l.t[l.p] = e, l = l._next;
                    ...
                    vt = (V._parseToProxy = function(t, e, i, s, r, n) {
                        ...
                        for (i._transform = null, N = e, s = _ = i.parse(t, e, s, r), N = d, n && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); s && s !== u;) {
                            if (s.type <= 1 && (o = s.p, c[o] = s.s + s.c, f[o] = s.s, n || (h = new yt(s, "s", o, h, s.r), s.c = 0), 1 === s.type))
                                for (a = s.l; --a > 0;) l = "xn" + a, o = s.p + "_" + l, c[o] = s.data[l], f[o] = s[l], n || (h = new yt(s, l, o, h, s.rxp[l]));
                            s = s._next
                        }
                        return {
                            proxy: f,
                        ...
                        this.t = t, this.p = e, this.s = s, this.c = r, this.n = l || e, t instanceof vt || n.push(this.n), this.r = h ? "function" == typeof h ? h : Math.round : h, this.type = o || 0, _ && (this.pr = _, i = !0), this.b = void 0 === u ? s : u, this.e = void 0 === f ? s + r : f, a && (this._next = a, a._prev = this)
                    }),
                    ...
                    xt = a.parseComplex = function(t, e, i, s, r, n, o, l, h, u) {
                        ...
                        var f, c, p, d, T, x, b, w, P, O, S, k, R, A = i.split(", ").join(",").split(" "),
                            ...
                            M = A.length,
                            D = _ !== !1;
                        for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (-1 !== (s + i).indexOf("rgb") || -1 !== (s + i).indexOf("hsl") ? (A = A.join(" ").replace(z, ", ").split(" "), C = C.join(" ").replace(z, ", ").split(" ")) : (A = A.join(" ").split(",").join(", ").split(" "), C = C.join(" ").split(",").join(", ").split(" ")), M = A.length), M !== C.length && (A = (n || "").split(" "), M = A.length), o.plugin = h, o.setRatio = u, dt.lastIndex = 0, f = 0; M > f; f++)
                            if (d = A[f], T = C[f] + "", w = parseFloat(d), w || 0 === w) o.appendXtra("", w, lt(T, w), T.replace(v, ""), !(!D || -1 === T.indexOf("px")) && Math.round, !0);
                            else if (r && dt.test(d)) k = T.indexOf(")") + 1, k = ")" + (k ? T.substr(k) : ""), R = -1 !== T.indexOf("hsl") && W, O = T, d = ct(d, R), T = ct(T, R), P = d.length + T.length > 6, P && !W && 0 === T[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent", o.e = o.e.split(C[f]).join("transparent")) : (W || (P = !1), R ? o.appendXtra(O.substr(0, O.indexOf("hsl")) + (P ? "hsla(" : "hsl("), d[0], lt(T[0], d[0]), ",", !1, !0).appendXtra("", d[1], lt(T[1], d[1]), "%,", !1).appendXtra("", d[2], lt(T[2], d[2]), P ? "%," : "%" + k, !1) : o.appendXtra(O.substr(0, O.indexOf("rgb")) + (P ? "rgba(" : "rgb("), d[0], T[0] - d[0], ",", Math.round, !0).appendXtra("", d[1], T[1] - d[1], ",", Math.round).appendXtra("", d[2], T[2] - d[2], P ? "," : k, Math.round), P && (d = d.length < 4 ? 1 : d[3], o.appendXtra("", d, (T.length < 4 ? 1 : T[3]) - d, k, !1))), dt.lastIndex = 0;
                        else if (x = d.match(y)) {
                            if (b = T.match(v), !b || b.length !== x.length) return o;
                            for (p = 0, c = 0; c < x.length; c++) S = x[c], O = d.indexOf(S, p), o.appendXtra(d.substr(p, O - p), Number(S), lt(b[c], S), "", !(!D || "px" !== d.substr(O + S.length, 2)) && Math.round, 0 === c), p = O + S.length;
                            o["xs" + o.l] += d.substr(p)
                    ...
                    bt = 9;
                for (h = vt.prototype, h.l = h.pr = 0; --bt > 0;) h["xn" + bt] = 0, h["xs" + bt] = "";
                ...
                var St, kt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    It = function() {
                        ...
                        return B.createElementNS && !s && (t = zt("svg", Et), e = zt("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        }), i = e.getBoundingClientRect().width, e.style[Ct] = "50% 50%", e.style[Rt] = "scaleX(0.5)", s = i === e.getBoundingClientRect().width && !(c && Mt), Et.removeChild(t)), s
                    }(),
                    Xt = function(t, e, i, s, r, n) {
                        var o, l, h, _, u, f, c, p, d, m, g, y, v, T, x = t._gsTransform,
                            b = jt(t, !0);
                        x && (v = x.xOrigin, T = x.yOrigin), (!s || (o = s.split(" ")).length < 2) && (c = t.getBBox(), 0 === c.x && 0 === c.y && c.width + c.height === 0 && (c = {
                            x: parseFloat(t.hasAttribute("x") ? t.getAttribute("x") : t.hasAttribute("cx") ? t.getAttribute("cx") : 0) || 0,
                            y: parseFloat(t.hasAttribute("y") ? t.getAttribute("y") : t.hasAttribute("cy") ? t.getAttribute("cy") : 0) || 0,
                            width: 0,
                            height: 0
                        }), e = ot(e).split(" "), o = [(-1 !== e[0].indexOf("%") ? parseFloat(e[0]) / 100 * c.width : parseFloat(e[0])) + c.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * c.height : parseFloat(e[1])) + c.y]), i.xOrigin = _ = parseFloat(o[0]), i.yOrigin = u = parseFloat(o[1]), s && b !== Yt && (f = b[0], c = b[1], p = b[2], d = b[3], m = b[4], g = b[5], y = f * d - c * p, y && (l = _ * (d / y) + u * (-p / y) + (p * g - d * m) / y, h = _ * (-c / y) + u * (f / y) - (f * g - c * m) / y, _ = i.xOrigin = o[0] = l, u = i.yOrigin = o[1] = h)), x && (n && (i.xOffset = x.xOffset, i.yOffset = x.yOffset, x = i), r || r !== !1 && a.defaultSmoothOrigin !== !1 ? (l = _ - v, h = u - T, x.xOffset += l * b[0] + h * b[2] - l, x.yOffset += l * b[1] + h * b[3] - h) : x.xOffset = x.yOffset = 0), n || t.setAttribute("data-svg-origin", o.join(" "))
                    },
                    Nt = function(t) {
                        ...
                        return r ? s.insertBefore(this, r) : s.appendChild(this), Et.removeChild(i), this.style.cssText = n, e
                    },
                    Lt = function(t) {
                        try {
                            return t.getBBox()
                    ...
                    Ut = V.getTransform = function(t, i, s, r) {
                        ...
                        var n, o, l, h, _, u, f = s ? t._gsTransform || new Dt : new Dt,
                            ...
                            p = 2e-5,
                            d = 1e5,
                            m = Mt ? parseFloat(J(t, Ct, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0,
                            g = parseFloat(a.defaultTransformPerspective) || 0;
                        if (f.svg = !(!t.getCTM || !Bt(t)), f.svg && (Xt(t, J(t, Ct, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), St = a.useSVGTransformAttr || It), n = jt(t), n !== Yt) {
                            if (16 === n.length) {
                                var y, v, T, x, b, w = n[0],
                                    P = n[1],
                                    O = n[2],
                                ...
                                var B = n.length >= 6,
                                    ...
                                    U = n[2] || 0,
                                    V = B ? n[3] : 1;
                                f.x = n[4] || 0, f.y = n[5] || 0, l = Math.sqrt(Y * Y + j * j), h = Math.sqrt(V * V + U * U), _ = Y || j ? Math.atan2(j, Y) * X : f.rotation || 0, u = U || V ? Math.atan2(U, V) * X + _ : f.skewX || 0, f.scaleX = l, f.scaleY = h, f.rotation = _, f.skewX = u, Mt && (f.rotationX = f.rotationY = f.z = 0, f.perspective = g, f.scaleZ = 1), f.svg && (f.x -= f.xOrigin - (f.xOrigin * Y + f.yOrigin * U), f.y -= f.yOrigin - (f.xOrigin * j + f.yOrigin * V))
                            }
                            Math.abs(f.skewX) > 90 && Math.abs(f.skewX) < 270 && (c ? (f.scaleX *= -1, f.skewX += f.rotation <= 0 ? 180 : -180, f.rotation += f.rotation <= 0 ? 180 : -180) : (f.scaleY *= -1, f.skewX += f.skewX <= 0 ? 180 : -180)), f.zOrigin = m;
                    ...
                    qt = V.set3DTransformRatio = V.setTransformRatio = function(t) {
                        var e, i, s, r, n, a, o, l, h, _, u, f, p, d, m, g, y, v, T, x, b, w, P, O = this.data,
                            ...
                            B = O.skewY,
                            Y = O.skewX;
                        if (B && (Y += B, k += B), ((1 === t || 0 === t) && "auto" === L && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !L) && !E && !N && !A && !R && 1 === D || St && X || !Mt) return void(k || Y || X ? (k *= I, w = Y * I, P = 1e5, i = Math.cos(k) * C, n = Math.sin(k) * C, s = Math.sin(k - w) * -M, a = Math.cos(k - w) * M, w && "simple" === O.skewType && (e = Math.tan(w - B * I), e = Math.sqrt(1 + e * e), s *= e, a *= e, B && (e = Math.tan(B * I), e = Math.sqrt(1 + e * e), i *= e, n *= e)), X && (F += O.xOrigin - (O.xOrigin * i + O.yOrigin * s) + O.xOffset, z += O.yOrigin - (O.xOrigin * n + O.yOrigin * a) + O.yOffset, St && (O.xPercent || O.yPercent) && (m = this.t.getBBox(), F += .01 * O.xPercent * m.width, z += .01 * O.yPercent * m.height), m = 1e-6, m > F && F > -m && (F = 0), m > z && z > -m && (z = 0)), T = (i * P | 0) / P + "," + (n * P | 0) / P + "," + (s * P | 0) / P + "," + (a * P | 0) / P + "," + F + "," + z + ")", X && St ? this.t.setAttribute("transform", "matrix(" + T) : S[Rt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + T) : S[Rt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + C + ",0,0," + M + "," + F + "," + z + ")");
                        if (c && (m = 1e-4, m > C && C > -m && (C = D = 2e-5), m > M && M > -m && (M = D = 2e-5), !N || O.z || O.rotationX || O.rotationY || (N = 0)), k || Y) k *= I, g = i = Math.cos(k), y = n = Math.sin(k), Y && (k -= Y * I, g = Math.cos(k), y = Math.sin(k), "simple" === O.skewType && (e = Math.tan((Y - B) * I), e = Math.sqrt(1 + e * e), g *= e, y *= e, O.skewY && (e = Math.tan(B * I), e = Math.sqrt(1 + e * e), i *= e, n *= e))), s = -y, a = g;
                        else {
                            if (!(A || R || 1 !== D || N || X)) return void(S[Rt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) translate3d(" : "translate3d(") + F + "px," + z + "px," + E + "px)" + (1 !== C || 1 !== M ? " scale(" + C + "," + M + ")" : ""));
                            i = a = 1, s = n = 0
                        }
                        _ = 1, r = o = l = h = u = f = 0, p = N ? -1 / N : 0, d = O.zOrigin, m = 1e-6, x = ",", b = "0", k = A * I, k && (g = Math.cos(k), y = Math.sin(k), l = -y, u = p * -y, r = i * y, o = n * y, _ = g, p *= g, i *= g, n *= g), k = R * I, k && (g = Math.cos(k), y = Math.sin(k), e = s * g + r * y, v = a * g + o * y, h = _ * y, f = p * y, r = s * -y + r * g, o = a * -y + o * g, _ *= g, p *= g, s = e, a = v), 1 !== D && (r *= D, o *= D, _ *= D, p *= D), 1 !== M && (s *= M, a *= M, h *= M, f *= M), 1 !== C && (i *= C, n *= C, l *= C, u *= C), (d || X) && (d && (F += r * -d, z += o * -d, E += _ * -d + d), X && (F += O.xOrigin - (O.xOrigin * i + O.yOrigin * s) + O.xOffset, z += O.yOrigin - (O.xOrigin * n + O.yOrigin * a) + O.yOffset), m > F && F > -m && (F = b), m > z && z > -m && (z = b), m > E && E > -m && (E = 0)), T = O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix3d(" : "matrix3d(", T += (m > i && i > -m ? b : i) + x + (m > n && n > -m ? b : n) + x + (m > l && l > -m ? b : l), T += x + (m > u && u > -m ? b : u) + x + (m > s && s > -m ? b : s) + x + (m > a && a > -m ? b : a), R || A || 1 !== D ? (T += x + (m > h && h > -m ? b : h) + x + (m > f && f > -m ? b : f) + x + (m > r && r > -m ? b : r), T += x + (m > o && o > -m ? b : o) + x + (m > _ && _ > -m ? b : _) + x + (m > p && p > -m ? b : p) + x) : T += ",0,0,0,0,1,0,", T += F + x + z + x + E + x + (N ? 1 + -E / N : 1) + ")", S[Rt] = T
                    };
                h = Dt.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, Pt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, s, n, o, l) {
                        ...
                        var u, f, c, p, d, y, v, T, x, b = t._gsTransform,
                            ...
                            k = {},
                            R = "transformOrigin",
                            A = Ut(t, r, !0, S.parseTransform),
                            C = S.transform && ("function" == typeof S.transform ? S.transform(g, m) : S.transform);
                        if (A.skewType = S.skewType || A.skewType || a.defaultSkewType, s._transform = A, C && "string" == typeof C && Rt) f = j.style, f[Rt] = C, f.display = "block", f.position = "absolute", -1 !== C.indexOf("%") && (f.width = J(t, "width"), f.height = J(t, "height")), B.body.appendChild(j), u = Ut(j, null, !1), "simple" === A.skewType && (u.scaleY *= Math.cos(u.skewX * I)), A.svg && (y = A.xOrigin, v = A.yOrigin, u.x -= A.xOffset, u.y -= A.yOffset, (S.transformOrigin || S.svgOrigin) && (C = {}, Xt(t, ot(S.transformOrigin), C, S.svgOrigin, S.smoothOrigin, !0), y = C.xOrigin, v = C.yOrigin, u.x -= C.xOffset - A.xOffset, u.y -= C.yOffset - A.yOffset), (y || v) && (T = jt(j, !0), u.x -= y - (y * T[0] + v * T[2]), u.y -= v - (y * T[1] + v * T[3]))), B.body.removeChild(j), u.perspective || (u.perspective = A.perspective), null != S.xPercent && (u.xPercent = ht(S.xPercent, A.xPercent)), null != S.yPercent && (u.yPercent = ht(S.yPercent, A.yPercent));
                            ...
                            "string" == typeof S.x && -1 !== S.x.indexOf("%") && (u.x = 0, u.xPercent = ht(S.x, A.xPercent)), "string" == typeof S.y && -1 !== S.y.indexOf("%") && (u.y = 0, u.yPercent = ht(S.y, A.yPercent)), u.rotation = _t("rotation" in S ? S.rotation : "shortRotation" in S ? S.shortRotation + "_short" : "rotationZ" in S ? S.rotationZ : A.rotation, A.rotation, "rotation", k), Mt && (u.rotationX = _t("rotationX" in S ? S.rotationX : "shortRotationX" in S ? S.shortRotationX + "_short" : A.rotationX || 0, A.rotationX, "rotationX", k), u.rotationY = _t("rotationY" in S ? S.rotationY : "shortRotationY" in S ? S.shortRotationY + "_short" : A.rotationY || 0, A.rotationY, "rotationY", k)), u.skewX = _t(S.skewX, A.skewX), u.skewY = _t(S.skewY, A.skewY)
                        }
                        for (Mt && null != S.force3D && (A.force3D = S.force3D, p = !0), c = A.force3D || A.z || A.rotationX || A.rotationY || u.z || u.rotationX || u.rotationY || u.perspective, c || null == S.scale || (u.scaleZ = 1); --O > -1;) x = kt[O], C = u[x] - A[x], (C > P || -P > C || null != S[x] || null != N[x]) && (p = !0, n = new vt(A, x, A[x], C, n), x in k && (n.e = k[x]), n.xs0 = 0, n.plugin = o, s._overwriteProps.push(n.n));
                        return C = S.transformOrigin, A.svg && (C || S.svgOrigin) && (y = A.xOffset, v = A.yOffset, Xt(t, ot(C), u, S.svgOrigin, S.smoothOrigin), n = Tt(A, "xOrigin", (b ? A : u).xOrigin, u.xOrigin, n, R), n = Tt(A, "yOrigin", (b ? A : u).yOrigin, u.yOrigin, n, R), (y !== A.xOffset || v !== A.yOffset) && (n = Tt(A, "xOffset", b ? y : A.xOffset, A.xOffset, n, R), n = Tt(A, "yOffset", b ? v : A.yOffset, A.yOffset, n, R)), C = "0px 0px"), (C || Mt && c && A.zOrigin) && (Rt ? (p = !0, x = Ct, C = (C || J(t, x, r, !1, "50% 50%")) + "", n = new vt(w, x, 0, 0, n, (-1), R), n.b = w[x], n.plugin = o, Mt ? (f = A.zOrigin, C = C.split(" "), A.zOrigin = (C.length > 2 && (0 === f || "0px" !== C[2]) ? parseFloat(C[2]) : f) || 0, n.xs0 = n.e = C[0] + " " + (C[1] || "50%") + " 0px", n = new vt(A, "zOrigin", 0, 0, n, (-1), n.n), n.b = f, n.xs0 = n.e = A.zOrigin) : n.xs0 = n.e = C) : ot(C + "", A)), p && (s._transformType = A.svg && St || !c && 3 !== this._transformType ? 2 : 3), h && (l[i] = h), _ && (l.scale = _), n
                    },
                    prefix: !0
                }), Pt("boxShadow", {
                    ...
                    parser: function(t, e, i, s, n, a) {
                        ...
                        if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && (f = J(t, "backgroundImage").replace(A, ""), f && "none" !== f)) {
                            for (o = m.split(" "), l = g.split(" "), U.setAttribute("src", f), h = 2; --h > -1;) m = o[h], _ = -1 !== m.indexOf("%"), _ !== (-1 !== l[h].indexOf("%")) && (u = 0 === h ? t.offsetWidth - U.width : t.offsetHeight - U.height, o[h] = _ ? parseFloat(m) / 100 * u + "px" : parseFloat(m) / u * 100 + "%");
                            m = o.join(" ")
                        }
                    ...
                    formatter: function(t) {
                        return t += "", "co" === t.substr(0, 2) ? t : ot(-1 === t.indexOf(" ") ? t + " " + t : t)
                    }
                }), Pt("perspective", {
                    defaultValue: "0px",
                    prefix: !0
                ...
                Pt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, s, n, a) {
                        var o = parseFloat(J(t, "opacity", r, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + o), h && 1 === o && "hidden" === J(t, "visibility", r) && 0 !== e && (o = 0), W ? n = new vt(l, "opacity", o, e - o, n) : (n = new vt(l, "opacity", 100 * o, 100 * (e - o), n), n.xn1 = h ? 1 : 0, l.zoom = 1, n.type = 2, n.b = "alpha(opacity=" + n.s + ")", n.e = "alpha(opacity=" + (n.s + n.c) + ")", n.data = t, n.plugin = a, n.setRatio = Wt), h && (n = new vt(l, "visibility", 0, 0, n, (-1), null, (!1), 0, 0 !== o ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), n.xs0 = "inherit", s._overwriteProps.push(n.n), s._overwriteProps.push(i)), n
                    }
                });
                var Gt = function(t, e) {
                ...
                Pt("className", {
                    parser: function(t, e, s, n, a, o, l) {
                        var h, _, u, f, c, p = t.getAttribute("class") || "",
                            d = t.style.cssText;
                        if (a = n._classNamePT = new vt(t, s, 0, 0, a, 2), a.setRatio = Zt, a.pr = -11, i = !0, a.b = p, _ = it(t, r), u = t._gsClassPT) {
                ...
                var Ht = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) a.cssText = "", r = !0;
                            ...
                            for (e = this.e.split(" ").join("").split(","), s = e.length; --s > -1;) i = e[s], l[i] && (l[i].parse === o ? r = !0 : i = "transformOrigin" === i ? Ct : l[i].p), Gt(a, i);
                        r && (Gt(a, Rt), n = this.t._gsTransform, n && (n.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
                    }
                };
                for (Pt("clearProps", {
                        parser: function(t, e, s, r, n) {
                            return n = new vt(t, s, 0, 0, n, 2), n.setRatio = Ht, n.e = e, n.pr = -10, n.data = r._tween, i = !0, n
                        }
                ...
                h = a.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, o, h) {
                    ...
                    if (u && "" === S.zIndex && (c = J(t, "zIndex", r), ("auto" === c || "" === c) && this._addLazySet(S, "zIndex", 0)), "string" == typeof e && (v = S.cssText, c = it(t, r), S.cssText = v + ";" + e, c = st(t, c, it(t)).difs, !W && P.test(e) && (c.opacity = parseFloat(RegExp.$1)), e = c, S.cssText = v), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
                        for (O = 3 === this._transformType, Rt ? f && (u = !0, "" === S.zIndex && (b = J(t, "zIndex", r), ("auto" === b || "" === b) && this._addLazySet(S, "zIndex", 0)), p && this._addLazySet(S, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (O ? "visible" : "hidden"))) : S.zoom = 1, y = d; y && y._next;) y = y._next;
                        w = new vt(t, "transform", 0, 0, null, 2), this._linkCSSP(w, null, y), w.setRatio = Rt ? qt : Vt, w.data = this._transform || Ut(t, r, !0), w.tween = o, w.pr = -1, n.pop()
                    }
                    if (i) {
                        for (; d;) {
                    ...
                    for (a in e) {
                        if (c = e[a], "function" == typeof c && (c = c(g, m)), o = l[a]) i = o.parse(t, c, a, this, i, n, e);
                        else {
                            if ("--" === a.substr(0, 2)) {
                                this._tween._propLookup[a] = this._addTween.call(this._tween, t.style, "setProperty", K(t).getPropertyValue(a) + "", c + "", a, !1, a);
                                continue
                            }
                            f = J(t, a, r) + "", y = "string" == typeof c, "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || y && S.test(c) ? (y || (c = ct(c), c = (c.length > 3 ? "rgba(" : "rgb(") + c.join(",") + ")"), i = xt(T, a, f, c, !0, "transparent", i, 0, n)) : y && E.test(c) ? i = xt(T, a, f, c, !0, null, i, 0, n) : (h = parseFloat(f), p = h || 0 === h ? f.substr((h + "").length) : "", ("" === f || "auto" === f) && ("width" === a || "height" === a ? (h = at(t, a, r), p = "px") : "left" === a || "top" === a ? (h = et(t, a, r), p = "px") : (h = "opacity" !== a ? 0 : 1, p = "")), v = y && "=" === c.charAt(1), v ? (u = parseInt(c.charAt(0) + "1", 10), c = c.substr(2), u *= parseFloat(c), d = c.replace(b, "")) : (u = parseFloat(c), d = y ? c.replace(b, "") : ""), "" === d && (d = a in s ? s[a] : p), c = u || 0 === u ? (v ? u + h : u) + d : e[a], p !== d && ("" !== d || "lineHeight" === a) && (u || 0 === u) && h && (h = tt(t, a, h, p), "%" === d ? (h /= tt(t, a, 100, "%") / 100, e.strictUnits !== !0 && (f = h + "%")) : "em" === d || "rem" === d || "vw" === d || "vh" === d ? h /= tt(t, a, 1, d) : "px" !== d && (u = tt(t, a, u, d), d = "px"), v && (u || 0 === u) && (c = u + h + d)), v && (u += h), !h && 0 !== h || !u && 0 !== u ? void 0 !== T[a] && (c || c + "" != "NaN" && null != c) ? (i = new vt(T, a, u || h || 0, 0, i, (-1), a, (!1), 0, f, c), i.xs0 = "none" !== c || "display" !== a && -1 === a.indexOf("Style") ? c : f) : Z("invalid " + a + " tween value: " + e[a]) : (i = new vt(T, a, h, u - h, i, 0, a, _ !== !1 && ("px" === d || "zIndex" === a), 0, f, c), i.xs0 = d))
                        }
                    ...
                    if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
                        if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6)
                            for (; r;) {
                                if (e = r.c * t + r.s, r.r ? e = r.r(e) : n > e && e > -n && (e = 0), r.type)
                                    if (1 === r.type)
                    ...
                    this._transform = this._transform || Ut(this._target, r, !0), this._transformType = this._transform.svg && St || !t && 3 !== this._transformType ? 2 : 3
                };
                var $t = function(t) {
                ...
                h._addLazySet = function(t, e, i) {
                    ...
                    s.e = i, s.setRatio = $t, s.data = this
                ...
                var Qt = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (s = t.childNodes, r = s.length; --r > -1;) n = s[r], a = n.type, n.style && (e.push(it(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Qt(n, e, i)
                };
                return a.cascadeTo = function(t, i, s) {
                    ...
                    for (t = l._targets || l.target, Qt(t, _, f), l.render(i, !0, !0), Qt(t, u), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
                        if (n = st(f[r], _[r], u[r]), n.firstMPT) {
                            n = n.difs;
            ...
            function() {
                ...
                s._onInitAllProps = function() {
                    ...
                    for (n in l)
                        for (t = a._firstPT; t;) s = t._next, t.pg ? t.t._mod(l) : t.n === n && (2 === t.f && t.t ? i(t.t._firstPT, l[n]) : (this._add(t.t, n, t.s, t.c, l[n]), s && (s._prev = t._prev), t._prev ? t._prev._next = s : a._firstPT === t && (a._firstPT = s), t._next = t._prev = null, a._propLookup[n] = h)), t = s;
                    return !1
            ...
            function() {
                ...
                var e, i, s, r, n = _gsScope.GreenSockGlobals || _gsScope,
                    a = n.com.greensock,
                    o = 2 * Math.PI,
                    l = Math.PI / 2,
                    h = a._class,
    ...
    function(t, e) {
        ...
        var a, o, l, h, _, u = function(t) {
            ...
            y = function(s, n, a, o) {
                ...
                this.check = function(h) {
                    for (var _, f, c, p, d = n.length, m = d; --d > -1;)(_ = g[n[d]] || new y(n[d], [])).gsClass ? (l[d] = _.gsClass, m--) : h && _.sc.push(this);
                    if (0 === m && a) {
                        if (f = ("com.greensock." + s).split("."), c = f.pop(), p = u(f.join("."))[c] = this.gsClass = a.apply(a, l), o)
                            if (r[c] = i[c] = p, "undefined" != typeof module && module.exports)
                                if (s === e) {
        ...
        var x = [0, 0, 1, 1],
            ...
            P = b.register = function(t, e, i, s) {
                for (var r, n, a, o, l = e.split(","), h = l.length, _ = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1;)
                    for (n = l[h], r = s ? T("easing." + n, null, !0) : f.easing[n] || {}, a = _.length; --a > -1;) o = _[a], w[n + "." + o] = w[o + n] = r[o] = t.getRatio ? t : t[o] || new t
            };
        ...
        var S = t.requestAnimationFrame,
            ...
            A = R();
        for (a = ["ms", "moz", "webkit", "o"], o = a.length; --o > -1 && !S;) S = t[a[o] + "RequestAnimationFrame"], k = t[a[o] + "CancelAnimationFrame"] || t[a[o] + "CancelRequestAnimationFrame"];
        T("Ticker", function(t, e) {
            var i, r, n, a, o, l = this,
                ...
                y = function(t) {
                    var e, s, h = R() - A;
                    h > p && (u += h - m), A += h, l.time = (A - u) / 1e3, e = l.time - o, (!i || e > 0 || t === !0) && (l.frame++, o += e + (e >= a ? .004 : a - e), s = !0), t !== !0 && (n = r(y)), s && l.dispatchEvent(g)
                };
            O.call(l), l.time = l.frame = 0, l.tick = function() {
                y(!0)
            }, l.lagSmoothing = function(t, e) {
                return arguments.length ? (p = t || 1 / c, void(m = Math.min(e, p, 0))) : 1 / c > p
            }, l.sleep = function() {
                null != n && (f && k ? k(n) : clearTimeout(n), r = d, n = null, l === h && (_ = !1))
            }, l.wake = function(t) {
                null !== n ? l.sleep() : t ? u += -A + (A = R()) : l.frame > 10 && (A = R() - p + 5), r = 0 === i ? d : f && S ? S : function(t) {
        ...
        M(), l.play = function(t, e) {
            ...
            var e, i;
            for (t = t || c, this._timeline && this._timeline.smoothChildTiming && (e = this._pauseTime,
                    i = e || 0 === e ? e : this._timeline.totalTime(), this._startTime = i - (i - this._startTime) * this._timeScale / t), this._timeScale = t, i = this.timeline; i && i.timeline;) i._dirty = !0, i.totalDuration(), i = i.timeline;
            return this
        ...
        l = D.prototype = new C, l.constructor = D, l.kill()._gc = !1, l._first = l._last = l._recent = null, l._sortChildren = !1, l.add = l.insert = function(t, e, i, s) {
            var r, n;
        ...
        var F = T("TweenLite", function(e, i, s) {
                ...
                if (this._overwrite = l = null == l ? Z[F.defaultOverwrite] : "number" == typeof l ? l >> 0 : Z[l], (o || e instanceof Array || e.push && m(e)) && "number" != typeof e[0])
                    for (this._targets = a = p(e), this._propLookup = [], this._siblings = [], r = 0; r < a.length; r++) n = a[r], n ? "string" != typeof n ? n.length && n !== t && n[0] && (n[0] === t || n[0].nodeType && n[0].style && !n.nodeType) ? (a.splice(r--, 1), this._targets = a = a.concat(p(n))) : (this._siblings[r] = J(n, this, !1), 1 === l && this._siblings[r].length > 1 && et(n, this, null, 1, this._siblings[r])) : (n = a[r--] = F.selector(n), "string" == typeof n && a.splice(r + 1, 1)) : a.splice(r--, 1);
        ...
        l = F.prototype = new C, l.constructor = F, l.kill()._gc = !1, l.ratio = 0, l._firstPT = l._targets = l._overwrittenProps = l._startAt = null, l._notifyPluginsOfEnabled = l._lazy = !1, F.version = "2.0.1", F.defaultEase = l._ease = new b(null, null, 1, 1), F.defaultOverwrite = "auto", F.ticker = h, F.autoSleep = 120, F.lagSmoothing = function(t, e) {
            h.lagSmoothing(t, e)
        }, F.selector = t.$ || t.jQuery || function(e) {
            var i = t.$ || t.jQuery;
            return i ? (F.selector = i, i(e)) : (s || (s = t.document), s ? s.querySelectorAll ? s.querySelectorAll(e) : s.getElementById("#" === e.charAt(0) ? e.substr(1) : e) : e)
        };
        var I = [],
            X = {},
            N = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            ...
            Y = function(t, e, i, s) {
                ...
                return c += e.substr(f), c && u.push(c), u.setRatio = B, L.test(e) && (u.end = null), u
            },
            j = function(t, e, i, s, r, n, a, o, l) {
                ...
                return ("number" != typeof f || "number" != typeof s && !c) && (a || isNaN(f) || !c && isNaN(s) || "boolean" == typeof f || "boolean" == typeof s ? (p.fp = a, h = Y(f, c ? parseFloat(p.s) + p.c + (p.s + "").replace(/[0-9\-\.]/g, "") : s, o || F.defaultStringFilter, p), p = {
                    t: h,
                    p: "setRatio",
                    s: 0,
                    c: 1,
        ...
        var J = function(t, e, i) {
            ...
            et = function(t, e, i, s, r) {
                ...
                var h, _ = e._startTime + c,
                    u = [],
                    f = 0,
                    p = 0 === e._duration;
                for (n = r.length; --n > -1;)(o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || it(e, 0, p), 0 === it(o, h, p) && (u[f++] = o)) : o._startTime <= _ && o._startTime + o.totalDuration() / o._timeScale > _ && ((p || !o._initted) && _ - o._startTime <= 2e-10 || (u[f++] = o)));
                for (n = f; --n > -1;)
        ...
        l._init = function() {
            ...
            if (a.startAt) {
                ...
                if (r.data = "isStart", r.overwrite = !1, r.immediateRender = !0, r.lazy = h && a.lazy !== !1, r.startAt = r.delay = null, r.onUpdate = a.onUpdate, r.onUpdateParams = a.onUpdateParams, r.onUpdateScope = a.onUpdateScope || a.callbackScope || this, this._startAt = F.to(this.target || {}, 0, r), h)
                ...
                } if (this._ease = _ = _ ? _ instanceof b ? _ : "function" == typeof _ ? new b(_, a.easeParams) : w[_] || F.defaultEase : F.defaultEase, a.easeParams instanceof Array && _.config && (this._ease = _.config.apply(_, a.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
            ...
            return r && this._kill(r, e) ? this._initProps(e, i, s, r, n) : this._overwrite > 1 && this._firstPT && s.length > 1 && et(e, this, i, this._overwrite, s) ? (this._kill(i, e), this._initProps(e, i, s, r, n)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (X[e._gsTweenID] = !0), l)
        }, l.render = function(t, e, i) {
            var s, r, n, a, o = this._time,
                l = this._duration,
                h = this._rawPrevTime;
            if (t >= l - 1e-7 && t >= 0) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (s = !0, r = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > h || 0 >= t && t >= -1e-7 || h === c && "isPause" !== this.data) && h !== t && (i = !0, h > c && (r = "onReverseComplete")), this._rawPrevTime = a = !e || t || h === t ? t : c);
            else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== o || 0 === l && h > 0) && (r = "onReverseComplete", s = this._reversed), 0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== c || "isPause" !== this.data) && (i = !0), this._rawPrevTime = a = !e || t || h === t ? t : c)), (!this._initted || this._startAt && this._startAt.progress()) && (i = !0);
            else if (this._totalTime = this._time = t, this._easeType) {
                var _ = t / l,
                    u = this._easeType,
                    f = this._easePower;
                (1 === u || 3 === u && _ >= .5) && (_ = 1 - _), 3 === u && (_ *= 2), 1 === f ? _ *= _ : 2 === f ? _ *= _ * _ : 3 === f ? _ *= _ * _ * _ : 4 === f && (_ *= _ * _ * _ * _), 1 === u ? this.ratio = 1 - _ : 2 === u ? this.ratio = _ : .5 > t / l ? this.ratio = _ / 2 : this.ratio = 1 - _ / 2
            ...
            if (this._time !== o || i) {
                ...
                for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== o && t >= 0 && (this._active = !0), 0 === o && (this._startAt && (t >= 0 ? this._startAt.render(t, !0, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === l) && (e || this._callback("onStart"))), n = this._firstPT; n;) n.f ? n.t[n.p](n.c * this.ratio + n.s) : n.t[n.p] = n.c * this.ratio + n.s, n = n._next;
                this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, !0, i), e || (this._time !== o || s || i) && this._callback("onUpdate")), r && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && t !== -1e-4 && this._startAt.render(t, !0, i), s && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[r] && this._callback(r), 0 === l && this._rawPrevTime === c && a !== c && (this._rawPrevTime = 0))
            }
        ...
        if (l = st.prototype, st.version = "1.19.0", st.API = 2, l._firstPT = null, l._addTween = j, l.setRatio = B, l._kill = function(t) {
    ...
    function t() {
        if (l.length) {
            ...
            for (n = n || ((d = {
                    ...
                    width: f.innerWidth
                }).height || !(t = r.compatMode) && e.support.boxModel || (d = {
                    height: (o = "CSS1Compat" === t ? a : r.body).clientHeight,
                    width: o.clientWidth
                }), d), i = i || {
                    top: f.pageYOffset || a.scrollTop || r.body.scrollTop,
                    left: f.pageXOffset || a.scrollLeft || r.body.scrollLeft
                }; c < l.length; c++)
                if (e.contains(a, h[c][0])) {
                    var s = e(h[c]),
                        u = s[0].offsetHeight,
                        p = s[0].offsetWidth,
                        g = s.offset(),
                        v = s.data("inview");
                    if (!i || !n) return;
                    g.top + u > i.top && g.top < i.top + n.height && g.left + p > i.left && g.left < i.left + n.width ? v || s.data("inview", !0).trigger("inview", [!0]) : v && s.data("inview", !1).trigger("inview", [!1])
                }
        }
    }
    var n, i, o, l = [],
    ...
    e.event.special.inview = {
        add: function(n) {
            l.push({
                ...
                $element: e(this),
                element: this
            }), !o && l.length && (o = setInterval(t, 250))
        },
        remove: function(e) {
            ...
            l.length || (clearInterval(o), o = null)
        }
    ...
    return function(e) {
        ...
        function o(e, t) {
            ...
            function i(e) {
                ...
                }), k.addEventListener(A.transitionEnd, x), m.call(k.children)
            }
            ...
            function s(e, t, n) {
                var i = k && k.style;
                i && (i[A.transition + "TimingFunction"] = n, i[A.transition + "Duration"] = t + "ms", A.hasTranslate3d ? i[A.transform] = "translate3d(" + e + "px, 0, 0)" : i[A.transform] = "translate(" + e + "px, 0)")
            }
            ...
            function c(e, t) {
                ...
                o("before", "slide", {
                    index: D,
                    nextSlide: p
                }), B && B.classList.remove("disabled"), T && T.classList.remove("disabled"), "number" != typeof e && (e = t ? d && D + 2 * d !== O.length ? D + (d - D % d) : D + a : d && D % d != 0 ? D - D % d : D - a), e = Math.min(Math.max(e, 0), O.length - 1), d && void 0 === t && (e += d);
                var b = Math.min(Math.max(-1 * O[e].offsetLeft, -1 * h), 0);
                l && Math.abs(M.x) === h && t && (b = 0, e = 0, v = c), s(b, v, u), M.x = b, O[e].offsetLeft <= h && (D = e), !d || e !== O.length - d && e !== O.length - O.length % d && 0 !== e || (t && (D = d), t || (D = O.length - 2 * d), M.x = -1 * O[D].offsetLeft, z = function() {
                    s(-1 * O[D].offsetLeft, 0, void 0)
                }), f && n(m.call(O), D), B && !d && 0 === e && B.classList.add("disabled"), !T || d || l || e + 1 !== O.length || T.classList.add("disabled"), o("after", "slide", {
                    currentSlide: D
                })
            }

            function f() {
                o("before", "init"), A = (0, a["default"])(), F = r({}, v["default"], t);
                var s = F,
                    d = s.classNameFrame,
                    l = s.classNameSlideContainer,
                    c = s.classNamePrevCtrl,
                    u = s.classNameNextCtrl,
                    f = s.enableMouseEvents,
                    h = s.classNameActiveSlide,
                    b = s.initialIndex;
                D = b, P = e.getElementsByClassName(d)[0], k = P.getElementsByClassName(l)[0], B = e.getElementsByClassName(c)[0], T = e.getElementsByClassName(u)[0], M = {
                    x: k.offsetLeft,
                    y: k.offsetTop
                }, F.infinite ? O = i(m.call(k.children)) : (O = m.call(k.children), B && B.classList.add("disabled"), T && 1 === O.length && !F.rewind && T.classList.add("disabled")), p(), h && n(O, D), B && T && (B.addEventListener("click", E), T.addEventListener("click", y)), P.addEventListener("touchstart", w, I), f && (P.addEventListener("mousedown", w), P.addEventListener("click", N)), F.window.addEventListener("resize", j), o("after", "init")
            }
            ...
            function p() {
                var e = F,
                    ...
                    l = e.initialIndex;
                _ = d(k), S = d(P), S === _ && (_ = O.reduce(function(e, t) {
                    return e + d(t)
                }, 0)), r ? D = l : (i = null, o = 0), t ? (s(-1 * O[D + t].offsetLeft, 0, null), D += t, M.x = -1 * O[D].offsetLeft) : (s(-1 * O[D].offsetLeft, o, i), M.x = -1 * O[D].offsetLeft), a && n(m.call(O), D)
            }
            ...
            function w(e) {
                ...
                n && (P.addEventListener("mousemove", g), P.addEventListener("mouseup", C), P.addEventListener("mouseleave", C)), P.addEventListener("touchmove", g, I), P.addEventListener("touchend", C);
                var r = i.pageX,
                    s = i.pageY;
                R = {
                    x: r,
            ...
            function g(e) {
                ...
                Q = {
                    x: n - R.x,
                    y: i - R.y
                }, void 0 === X && (X = !!(X || Math.abs(Q.x) < Math.abs(Q.y))), !X && R && s(M.x + Q.x, 0, null), o("on", "touchmove", {
                    event: e
                })
            }

            function C(e) {
                var t = R ? Date.now() - R.time : void 0,
                    n = Number(t) < 300 && Math.abs(Q.x) > 25 || Math.abs(Q.x) > S / 3,
                    i = !D && Q.x > 0 || D === O.length - 1 && Q.x < 0,
                    r = Q.x < 0;
                X || (n && !i ? c(!1, r) : s(M.x, F.snapBackSpeed)), R = void 0, P.removeEventListener("touchmove", g), P.removeEventListener("touchend", C), P.removeEventListener("mousemove", g), P.removeEventListener("mouseup", C), P.removeEventListener("mouseleave", C), o("on", "touchend", {
                    event: e
                })
            }
...
var SmoothScroll = function() {
    function e(e) {
        var t = this;
        this.endThreshold = .05, this.requestId = null, this.maxDepth = 10, this.viewHeight = 0, this.halfViewHeight = 0, this.maxDistance = 0, this.scrollHeight = 0, this.endScroll = 0, this.currentScroll = 0, this.resizeRequest = 1, this.scrollRequest = 0, this.scrollItems = [], this.lastTime = -1, this.maxElapsedMS = 100, this.targetFPMS = .06, this._onResize = function(e) {
            t.resizeRequest++, t.requestId || (t.lastTime = performance.now(), t.requestId = requestAnimationFrame(t._update))
        }, this._onScroll = function(e) {
            t.scrollRequest++, t.requestId || (t.lastTime = performance.now(), t.requestId = requestAnimationFrame(t._update))
        }, this._update = function(e) {
            void 0 === e && (e = performance.now());
            var s = e - t.lastTime;
            if (s > t.maxElapsedMS && (s = t.maxElapsedMS), $("body").hasClass("is-loading")) var r = 1e3;
            else var r = s * t.targetFPMS;
            var a = 1 - Math.pow(1 - t.scrollEase, r),
                i = t.resizeRequest > 0,
                l = window.pageYOffset;
            if (i) {
                var n = t.target.clientHeight;
                document.body.style.height = n + "px", t.scrollHeight = n, t.viewHeight = window.innerHeight, t.halfViewHeight = t.viewHeight / 2, t.maxDistance = 2 * t.viewHeight, t.resizeRequest = 0
            }
            t.endScroll = l, t.currentScroll += (l - t.currentScroll) * a, (Math.abs(l - t.currentScroll) < t.endThreshold || i) && (t.currentScroll = l, t.scrollRequest = 0);
            var o = t.currentScroll + t.halfViewHeight;
            t.target.style.transform = "translateY(-" + t.currentScroll + "px) translateZ(0)";
            for (var h = 0; h < t.scrollItems.length; h++) {
                var c = t.scrollItems[h],
                    d = o - c.top,
                    u = d / t.maxDistance;
                c.endOffset = Math.round(t.maxOffset * c.depthRatio * u), Math.abs(c.endOffset - c.currentOffset < t.endThreshold) ? c.currentOffset = c.endOffset : c.currentOffset += (c.endOffset - c.currentOffset) * a, c.target.style.transform = "translateY(" + c.currentOffset + "px) translateZ(0)"
            }
            t.lastTime = e, t.requestId = t.scrollRequest > 0 ? requestAnimationFrame(t._update) : null
        }, this.target = e.target, this.scrollEase = null != e.scrollEase ? e.scrollEase : .1, this.maxOffset = null != e.maxOffset ? e.maxOffset : 500, this.addItems(), window.addEventListener("resize", this._onResize), window.addEventListener("scroll", this._onScroll), this._update()
    }
    return e.prototype.addItems = function() {
        this.scrollItems = [];
        for (var e = document.querySelectorAll("*[data-depth]"), t = 0; t < e.length; t++) {
            var s = e[t],
        ...
        _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(e, t, r, n) {
            var i, o, s, a, c = function(t, r) {
                ...
                v = function(e, t, r, n, i) {
                    var o, s, a, c, p = t.length,
                        l = 0,
                        f = u;
                    if ("object" == typeof e) {
                        for (; --p > -1;) {
                            o = t[p], s = 0;
                            for (a in e) c = o[a] - e[a], s += c * c;
                            f > s && (l = p, f = s)
                        }
                        if (u > (i || u) && i < Math.sqrt(f)) return e
                    } else
                        for (; --p > -1;) o = t[p], s = o - e, 0 > s && (s = -s), f > s && o >= n && r >= o && (l = p, f = s);
                    return t[l]
                },
                d = function(e, t, r, n, i, o) {
                    if ("auto" === e.end) return e;
                    var s, a, c = e.end;
                    if (r = isNaN(r) ? u : r, n = isNaN(n) ? -u : n, "object" == typeof t) {
                        if (s = t.calculated ? t : ("function" == typeof c ? c(t) : v(t, c, r, n, o)) || t, !t.calculated) {
                            for (a in s) t[a] = s[a];
                            t.calculated = !0
                        }
                        s = s[i]
                    } else s = "function" == typeof c ? c(t) : c instanceof Array ? v(t, c, r, n, o) : Number(c);
                    return s > r ? s = r : n > s && (s = n), {
                        max: s,
                        min: s,
                ...
                y = c.calculateChange = function(e, n, i, o) {
                    null == o && (o = .05);
                    var s = n instanceof r ? n : n ? new r(n) : t.defaultEase;
                    return i * o * e / s.getRatio(o)
                },
                _ = c.calculateDuration = function(e, n, i, o, s) {
                    s = s || .05;
                    var a = o instanceof r ? o : o ? new r(o) : t.defaultEase;
                    return Math.abs((n - e) * a.getRatio(s) / i / s)
                },
                m = c.calculateTweenDuration = function(e, i, o, s, a, u) {
                    if ("string" == typeof e && (e = t.selector(e)), !e) return 0;
                    null == o && (o = 10), null == s && (s = .2), null == a && (a = 1), e.length && (e = e[0] || e);
                    var l, g, v, m, P, k, w, x, b, T, N, V, S, O = 0,
                        R = 9999999999,
                        B = i.throwProps || i,
                        j = i.ease instanceof r ? i.ease : i.ease ? new r(i.ease) : t.defaultEase,
                        F = isNaN(B.checkpoint) ? .05 : Number(B.checkpoint),
                        C = isNaN(B.resistance) ? c.defaultResistance : Number(B.resistance);
                    if (B.linkedProps)
                        for (V = B.linkedProps.split(","), N = {}, S = 0; S < V.length; S++) l = V[S], g = B[l], g && (void 0 !== g.velocity && "number" == typeof g.velocity ? m = Number(g.velocity) || 0 : (b = b || n.getByTarget(e), m = b && b.isTrackingProp(l) ? b.getVelocity(l) : 0), P = isNaN(g.resistance) ? C : Number(g.resistance), v = m * P > 0 ? m / P : m / -P, k = "function" == typeof e[l] ? e[l.indexOf("set") || "function" != typeof e["get" + l.substr(3)] ? l : "get" + l.substr(3)]() : e[l] || 0, N[l] = k + y(m, j, v, F));
                    for (l in B) "resistance" !== l && "checkpoint" !== l && "preventOvershoot" !== l && "linkedProps" !== l && "radius" !== l && (g = B[l], "object" != typeof g && (b = b || n.getByTarget(e), b && b.isTrackingProp(l) ? g = "number" == typeof g ? {
                        velocity: g
                    } : {
                        velocity: b.getVelocity(l)
                    } : (m = Number(g) || 0, v = m * C > 0 ? m / C : m / -C)), "object" == typeof g && (void 0 !== g.velocity && "number" == typeof g.velocity ? m = Number(g.velocity) || 0 : (b = b || n.getByTarget(e), m = b && b.isTrackingProp(l) ? b.getVelocity(l) : 0), P = isNaN(g.resistance) ? C : Number(g.resistance), v = m * P > 0 ? m / P : m / -P, k = "function" == typeof e[l] ? e[l.indexOf("set") || "function" != typeof e["get" + l.substr(3)] ? l : "get" + l.substr(3)]() : e[l] || 0, w = k + y(m, j, v, F), void 0 !== g.end && (g = d(g, N && l in N ? N : w, g.max, g.min, l, B.radius), (u || f) && (B[l] = h(g, B[l], "end"))), void 0 !== g.max && w > Number(g.max) + p ? (T = g.unitFactor || c.defaultUnitFactors[l] || 1, x = k > g.max && g.min !== g.max || m * T > -15 && 45 > m * T ? s + .1 * (o - s) : _(k, g.max, m, j, F), R > x + a && (R = x + a)) : void 0 !== g.min && w < Number(g.min) - p && (T = g.unitFactor || c.defaultUnitFactors[l] || 1, x = k < g.min && g.min !== g.max || m * T > -45 && 15 > m * T ? s + .1 * (o - s) : _(k, g.min, m, j, F), R > x + a && (R = x + a)), x > O && (O = x)), v > O && (O = v));
                    return O > R && (O = R), O > o ? o : s > O ? s : O
                },
                P = c.prototype = new e("throwProps");
            return P.constructor = c, c.version = "0.11.1", c.API = 2, c._autoCSS = !0, c.defaultResistance = 100, c.defaultUnitFactors = {
                time: 1e3,
                totalTime: 1e3
                    ...
                    t._registerComplexSpecialProp("throwProps", {
                        parser: function(e, t, u, p, l, f) {
                            ...
                            var v, d, h, y, _, m = {},
                                ...
                                b = {};
                            o = {};
                            for (h in t) "resistance" !== h && "preventOvershoot" !== h && "linkedProps" !== h && "radius" !== h && (d = t[h], "object" == typeof d ? (void 0 !== d.velocity && "number" == typeof d.velocity ? m[h] = Number(d.velocity) || 0 : (_ = _ || n.getByTarget(e), m[h] = _ && _.isTrackingProp(h) ? _.getVelocity(h) : 0), void 0 !== d.end && (w[h] = d.end), void 0 !== d.min && (P[h] = d.min), void 0 !== d.max && (k[h] = d.max), d.preventOvershoot && (b[h] = !0), void 0 !== d.resistance && (v = !0, x[h] = d.resistance)) : "number" == typeof d ? m[h] = d : (_ = _ || n.getByTarget(e), _ && _.isTrackingProp(h) ? m[h] = _.getVelocity(h) : m[h] = d || 0), g[h] && p._enableTransforms(2 === g[h]));
                            y = r(e, m, p, l, f), i = y.proxy, m = y.end;
                            for (h in i) o[h] = {
                                velocity: m[h],
                                min: P[h],
                                max: k[h],
                                ...
                                resistance: x[h],
                                preventOvershoot: b[h]
                            };
                            return null != t.resistance && (o.resistance = t.resistance), null != t.linkedProps && (o.linkedProps = t.linkedProps), null != t.radius && (o.radius = t.radius), t.preventOvershoot && (o.preventOvershoot = !0), l = new a(e, "throwProps", 0, 0, y.pt, 2), p._overwriteProps.pop(), l.plugin = f, l.setRatio = s, l.data = y, f._onInitTween(i, o, p._tween), l
                        }
                    })
                }
                ...
                var p = new t(e, c || 1, r);
                return p.render(0, !0, !0), p.vars.css ? (p.duration(m(i, {
                    throwProps: o,
                    ease: r.ease
                }, n, c, u)), p._delay && !p.vars.immediateRender ? p.invalidate() : s._onInitTween(i, a, p), f = !1, p) : (p.kill(), p = new t(e, m(e, r, n, c, u), r), f = !1, p)
            }, P._onInitTween = function(e, t, r, i) {
                this.target = e, this._props = [], s = this, a = t;
                var o, c, u, p, l, g, v, _, m, P, k, w, x = r._ease,
                    b = isNaN(t.checkpoint) ? .05 : Number(t.checkpoint),
                    T = r._duration,
                    N = t.preventOvershoot,
                    V = 0;
                if (t.linkedProps)
                    for (k = t.linkedProps.split(","), P = {}, w = 0; w < k.length; w++) o = k[w], c = t[o], c && (void 0 !== c.velocity && "number" == typeof c.velocity ? l = Number(c.velocity) || 0 : (m = m || n.getByTarget(e), l = m && m.isTrackingProp(o) ? m.getVelocity(o) : 0), u = "function" == typeof e[o] ? e[o.indexOf("set") || "function" != typeof e["get" + o.substr(3)] ? o : "get" + o.substr(3)]() : e[o] || 0, P[o] = u + y(l, x, T, b));
                for (o in t)
                    if ("resistance" !== o && "checkpoint" !== o && "preventOvershoot" !== o && "linkedProps" !== o && "radius" !== o) {
                        if (c = t[o], "function" == typeof c && (c = c(i, e)), "number" == typeof c) l = Number(c) || 0;
                        else if ("object" != typeof c || isNaN(c.velocity)) {
                            if (m = m || n.getByTarget(e), !m || !m.isTrackingProp(o)) throw "ERROR: No velocity was defined in the throwProps tween of " + e + " property: " + o;
                            l = m.getVelocity(o)
                        } else l = Number(c.velocity);
                        g = y(l, x, T, b), _ = 0, p = "function" == typeof e[o], u = p ? e[o.indexOf("set") || "function" != typeof e["get" + o.substr(3)] ? o : "get" + o.substr(3)]() : e[o], "object" == typeof c && (v = u + g, void 0 !== c.end && (c = d(c, P && o in P ? P : v, c.max, c.min, o, t.radius), f && (t[o] = h(c, t[o], "end"))), void 0 !== c.max && Number(c.max) < v ? N || c.preventOvershoot ? g = c.max - u : _ = c.max - u - g : void 0 !== c.min && Number(c.min) > v && (N || c.preventOvershoot ? g = c.min - u : _ = c.min - u - g)), this._overwriteProps[V] = o, this._props[V++] = {
                            p: o,
                            s: u,
                            c1: g,
                            c2: _,
                ...
                for (var t, r = this._props, n = r.length; --n > -1;) t = e[r[n].p] || e.throwProps, "function" == typeof t && (r[n].m = t)
            }, P.setRatio = function(e) {
                for (var t, r, n = this._props.length; --n > -1;) t = this._props[n], r = t.s + t.c1 * e + t.c2 * e * e, t.m ? r = t.m(r, this.target) : 1 === e && (r = (1e4 * r + (0 > r ? -.5 : .5) | 0) / 1e4), t.f ? this.target[t.p](r) : this.target[t.p] = r
            }, e.activate([c]), c
            ...
            var t, r, n, i, o = /([A-Z])/g,
                ...
                p = function(e, t, r) {
                    ...
                    return n || 0 === n ? n : (e.style[t] ? n = e.style[t] : (r = r || u(e, null)) ? n = r[t] || r.getPropertyValue(t) || r.getPropertyValue(t.replace(o, "-$1").toLowerCase()) : e.currentStyle && (n = e.currentStyle[t]), parseFloat(n) || 0)
                },
                l = e.ticker,
                f = function(e, t, r) {
                    this.p = e, this.f = t, this.v1 = this.v2 = 0, this.t1 = this.t2 = l.time, this.css = !1, this.type = "", this._prev = null, r && (this._next = r, r._prev = this)
                },
                g = function() {
                    var e, r, o = t,
                        s = l.time;
                    if (s - n >= .03)
                        for (i = n, n = s; o;) {
                            for (r = o._firstVP; r;) e = r.css ? p(o.target, r.p) : r.f ? o.target[r.p]() : o.target[r.p], (e !== r.v1 || s - r.t1 > .15) && (r.v2 = r.v1, r.v1 = e, r.t2 = r.t1, r.t1 = s), r = r._next;
                            o = o._next
                        }
                },
                v = function(e) {
                    this._lookup = {}, this.target = e, this.elem = !(!e.style || !e.nodeType), r || (l.addEventListener("tick", g, null, !1, -100), n = i = l.time, r = !0), t && (this._next = t, t._prev = this), t = this
                },
                d = v.getByTarget = function(e) {
                    for (var r = t; r;) {
            ...
            return h.addProp = function(t, r) {
                if (!this._lookup[t]) {
                    var n = this.target,
                        ...
                        o = i ? this._altProp(t) : t,
                        s = this._firstVP;
                    this._firstVP = this._lookup[t] = this._lookup[o] = s = new f(o !== t && 0 === t.indexOf("set") ? o : t, i, s), s.css = this.elem && (void 0 !== this.target.style[s.p] || c[s.p]), s.css && c[s.p] && !n._gsTransform && e.set(n, {
                        x: "+=0",
                        overwrite: !1
                    }), s.type = r || s.css && 0 === t.indexOf("rotation") ? "deg" : "", s.v1 = s.v2 = s.css ? p(n, s.p) : i ? n[s.p]() : n[s.p]
                }
                ...
                return this._lookup[e] instanceof f
            }, h.getVelocity = function(e) {
                var t, r, n, i = this._lookup[e],
                    o = this.target;
                if (!i) throw "The velocity of " + e + " is not being tracked.";
                return t = i.css ? p(o, i.p) : i.f ? o[i.p]() : o[i.p], r = t - i.v2, ("rad" === i.type || "deg" === i.type) && (n = "rad" === i.type ? 2 * Math.PI : 360, r %= n, r !== r % (n / 2) && (r = 0 > r ? r + n : r - n)), r / (l.time - i.t2)
                ...
                var n = d(e),
                    i = t.split(","),
                    o = i.length;
                for (r = (r || "").split(","), n || (n = new v(e)); --o > -1;) n.addProp(i[o], r[o] || r[0]);
                return n
